...
func (tr *ManagedInstance) GetObservation() (map[string]any, error) {
...
func (tr *ManagedInstance) SetObservation(obs map[string]any) error {
...
func (tr *ManagedInstance) GetParameters() (map[string]any, error) {
...
func (tr *ManagedInstance) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ManagedInstance
func (tr *ManagedInstance) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ManagedInstance
func (tr *ManagedInstance) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
