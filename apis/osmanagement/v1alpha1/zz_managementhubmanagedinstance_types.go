...
type ManagementHubManagedInstanceInitParameters struct {
	...
	// Reference to a ManagementHubManagementStation in osmanagement to populate primaryManagementStationId.
	// +kubebuilder:validation:Optional
	PrimaryManagementStationIDRef *v1.Reference `json:"primaryManagementStationIdRef,omitempty" tf:"-"`

	// Selector for a ManagementHubManagementStation in osmanagement to populate primaryManagementStationId.
	// +kubebuilder:validation:Optional
	...
	// Reference to a ManagementHubManagementStation in osmanagement to populate secondaryManagementStationId.
	// +kubebuilder:validation:Optional
	SecondaryManagementStationIDRef *v1.Reference `json:"secondaryManagementStationIdRef,omitempty" tf:"-"`

	// Selector for a ManagementHubManagementStation in osmanagement to populate secondaryManagementStationId.
	// +kubebuilder:validation:Optional
	SecondaryManagementStationIDSelector *v1.Selector `json:"secondaryManagementStationIdSelector,omitempty" tf:"-"`
}

type ManagementHubManagedInstanceObservation struct {
	...
	LifecycleEnvironment []LifecycleEnvironmentObservation `json:"lifecycleEnvironment,omitempty" tf:"lifecycle_environment,omitempty"`
...
type ManagementHubManagedInstanceParameters struct {
...
// ManagementHubManagedInstanceSpec defines the desired state of ManagementHubManagedInstance
type ManagementHubManagedInstanceSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ManagementHubManagedInstanceParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ManagementHubManagedInstanceInitParameters `json:"initProvider,omitempty"`
}

// ManagementHubManagedInstanceStatus defines the observed state of ManagementHubManagedInstance.
type ManagementHubManagedInstanceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ManagementHubManagedInstanceObservation `json:"atProvider,omitempty"`
}
...
// ManagementHubManagedInstance is the Schema for the ManagementHubManagedInstances API. Provides the Managed Instance resource in Oracle Cloud Infrastructure Os Management Hub service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type ManagementHubManagedInstance struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              ManagementHubManagedInstanceSpec   `json:"spec"`
	Status            ManagementHubManagedInstanceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ManagementHubManagedInstanceList contains a list of ManagementHubManagedInstances
type ManagementHubManagedInstanceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ManagementHubManagedInstance `json:"items"`
}

// Repository type metadata.
var (
	ManagementHubManagedInstance_Kind             = "ManagementHubManagedInstance"
	ManagementHubManagedInstance_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ManagementHubManagedInstance_Kind}.String()
	ManagementHubManagedInstance_KindAPIVersion   = ManagementHubManagedInstance_Kind + "." + CRDGroupVersion.String()
	ManagementHubManagedInstance_GroupVersionKind = CRDGroupVersion.WithKind(ManagementHubManagedInstance_Kind)
)

func init() {
	SchemeBuilder.Register(&ManagementHubManagedInstance{}, &ManagementHubManagedInstanceList{})
}
