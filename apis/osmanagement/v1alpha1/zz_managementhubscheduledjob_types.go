...
type ManagementHubScheduledJobInitParameters struct {
...
type ManagementHubScheduledJobObservation struct {
...
type ManagementHubScheduledJobParameters struct {
...
// ManagementHubScheduledJobSpec defines the desired state of ManagementHubScheduledJob
type ManagementHubScheduledJobSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ManagementHubScheduledJobParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ManagementHubScheduledJobInitParameters `json:"initProvider,omitempty"`
}

// ManagementHubScheduledJobStatus defines the observed state of ManagementHubScheduledJob.
type ManagementHubScheduledJobStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ManagementHubScheduledJobObservation `json:"atProvider,omitempty"`
}
...
// ManagementHubScheduledJob is the Schema for the ManagementHubScheduledJobs API. Provides the Scheduled Job resource in Oracle Cloud Infrastructure Os Management Hub service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type ManagementHubScheduledJob struct {
	...
	Spec   ManagementHubScheduledJobSpec   `json:"spec"`
	Status ManagementHubScheduledJobStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ManagementHubScheduledJobList contains a list of ManagementHubScheduledJobs
type ManagementHubScheduledJobList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ManagementHubScheduledJob `json:"items"`
}

// Repository type metadata.
var (
	ManagementHubScheduledJob_Kind             = "ManagementHubScheduledJob"
	ManagementHubScheduledJob_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ManagementHubScheduledJob_Kind}.String()
	ManagementHubScheduledJob_KindAPIVersion   = ManagementHubScheduledJob_Kind + "." + CRDGroupVersion.String()
	ManagementHubScheduledJob_GroupVersionKind = CRDGroupVersion.WithKind(ManagementHubScheduledJob_Kind)
)

func init() {
	SchemeBuilder.Register(&ManagementHubScheduledJob{}, &ManagementHubScheduledJobList{})
}
