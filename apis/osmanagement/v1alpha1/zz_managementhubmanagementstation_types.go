...
type ManagementHubManagementStationInitParameters struct {
...
type ManagementHubManagementStationObservation struct {
...
type ManagementHubManagementStationParameters struct {
...
// ManagementHubManagementStationSpec defines the desired state of ManagementHubManagementStation
type ManagementHubManagementStationSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ManagementHubManagementStationParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ManagementHubManagementStationInitParameters `json:"initProvider,omitempty"`
}

// ManagementHubManagementStationStatus defines the observed state of ManagementHubManagementStation.
type ManagementHubManagementStationStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ManagementHubManagementStationObservation `json:"atProvider,omitempty"`
}
...
// ManagementHubManagementStation is the Schema for the ManagementHubManagementStations API. Provides the Management Station resource in Oracle Cloud Infrastructure Os Management Hub service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type ManagementHubManagementStation struct {
	...
	Spec   ManagementHubManagementStationSpec   `json:"spec"`
	Status ManagementHubManagementStationStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ManagementHubManagementStationList contains a list of ManagementHubManagementStations
type ManagementHubManagementStationList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ManagementHubManagementStation `json:"items"`
}

// Repository type metadata.
var (
	ManagementHubManagementStation_Kind             = "ManagementHubManagementStation"
	ManagementHubManagementStation_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ManagementHubManagementStation_Kind}.String()
	ManagementHubManagementStation_KindAPIVersion   = ManagementHubManagementStation_Kind + "." + CRDGroupVersion.String()
	ManagementHubManagementStation_GroupVersionKind = CRDGroupVersion.WithKind(ManagementHubManagementStation_Kind)
)

func init() {
	SchemeBuilder.Register(&ManagementHubManagementStation{}, &ManagementHubManagementStationList{})
}
