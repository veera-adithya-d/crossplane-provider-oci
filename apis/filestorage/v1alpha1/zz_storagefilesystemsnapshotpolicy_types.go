...
type StorageFilesystemSnapshotPolicyInitParameters struct {
	...
	Locks []StorageFilesystemSnapshotPolicyLocksInitParameters `json:"locks,omitempty" tf:"locks,omitempty"`
...
type StorageFilesystemSnapshotPolicyLocksInitParameters struct {
...
type StorageFilesystemSnapshotPolicyLocksObservation struct {
...
type StorageFilesystemSnapshotPolicyLocksParameters struct {
...
type StorageFilesystemSnapshotPolicyObservation struct {
	...
	// Locks associated with this resource.
	Locks []StorageFilesystemSnapshotPolicyLocksObservation `json:"locks,omitempty" tf:"locks,omitempty"`
...
type StorageFilesystemSnapshotPolicyParameters struct {
	...
	// Locks associated with this resource.
	// +kubebuilder:validation:Optional
	Locks []StorageFilesystemSnapshotPolicyLocksParameters `json:"locks,omitempty" tf:"locks,omitempty"`
...
// StorageFilesystemSnapshotPolicySpec defines the desired state of StorageFilesystemSnapshotPolicy
type StorageFilesystemSnapshotPolicySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     StorageFilesystemSnapshotPolicyParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider StorageFilesystemSnapshotPolicyInitParameters `json:"initProvider,omitempty"`
}

// StorageFilesystemSnapshotPolicyStatus defines the observed state of StorageFilesystemSnapshotPolicy.
type StorageFilesystemSnapshotPolicyStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        StorageFilesystemSnapshotPolicyObservation `json:"atProvider,omitempty"`
}
...
// StorageFilesystemSnapshotPolicy is the Schema for the StorageFilesystemSnapshotPolicys API. Provides the Filesystem Snapshot Policy resource in Oracle Cloud Infrastructure File Storage service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type StorageFilesystemSnapshotPolicy struct {
	...
	Spec   StorageFilesystemSnapshotPolicySpec   `json:"spec"`
	Status StorageFilesystemSnapshotPolicyStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// StorageFilesystemSnapshotPolicyList contains a list of StorageFilesystemSnapshotPolicys
type StorageFilesystemSnapshotPolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []StorageFilesystemSnapshotPolicy `json:"items"`
}

// Repository type metadata.
var (
	StorageFilesystemSnapshotPolicy_Kind             = "StorageFilesystemSnapshotPolicy"
	StorageFilesystemSnapshotPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: StorageFilesystemSnapshotPolicy_Kind}.String()
	StorageFilesystemSnapshotPolicy_KindAPIVersion   = StorageFilesystemSnapshotPolicy_Kind + "." + CRDGroupVersion.String()
	StorageFilesystemSnapshotPolicy_GroupVersionKind = CRDGroupVersion.WithKind(StorageFilesystemSnapshotPolicy_Kind)
)

func init() {
	SchemeBuilder.Register(&StorageFilesystemSnapshotPolicy{}, &StorageFilesystemSnapshotPolicyList{})
}
