...
func (mg *FileSystem) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("filestorage.oci.upbound.io", "v1alpha1", "StorageFilesystemSnapshotPolicy", "StorageFilesystemSnapshotPolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
// ResolveReferences of this StorageFileSystemQuotaRule.
func (mg *StorageFileSystemQuotaRule) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this StorageFilesystemSnapshotPolicy.
func (mg *StorageFilesystemSnapshotPolicy) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this StorageOutboundConnector.
func (mg *StorageOutboundConnector) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
