...
func (in *IndexInitParameters) DeepCopyInto(out *IndexInitParameters) {
	*out = *in
	...
	if in.TableNameOrIDRef != nil {
		in, out := &in.TableNameOrIDRef, &out.TableNameOrIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.TableNameOrIDSelector != nil {
		in, out := &in.TableNameOrIDSelector, &out.TableNameOrIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
}
