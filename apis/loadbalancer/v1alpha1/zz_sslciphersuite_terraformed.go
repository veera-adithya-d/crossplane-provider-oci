...
// GetInitParameters of this SSLCipherSuite
func (tr *SSLCipherSuite) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SSLCipherSuite
func (tr *SSLCipherSuite) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
