...
// GetInitParameters of this RoutingPolicy
func (tr *RoutingPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RoutingPolicy
func (tr *RoutingPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
