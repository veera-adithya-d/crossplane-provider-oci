...
type CredentialDetailsInitParameters struct {
	...
	WalletSecretIDSecretRef *v1.LocalSecretKeySelector `json:"walletSecretIdSecretRef,omitempty" tf:"-"`
}
...
type DatabaseInsightInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/opsi/v1alpha1.ExadataInsight
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	ExadataInsightIDRef *v1.NamespacedReference `json:"exadataInsightIdRef,omitempty" tf:"-"`
