...
type SteeringPolicyAttachmentInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/dns/v1alpha1.SteeringPolicy
	...
	SteeringPolicyIDRef *v1.NamespacedReference `json:"steeringPolicyIdRef,omitempty" tf:"-"`
