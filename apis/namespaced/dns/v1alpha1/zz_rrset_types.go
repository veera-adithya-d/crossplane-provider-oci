...
type RrsetInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ZoneNameOrIDRef *v1.NamespacedReference `json:"zoneNameOrIdRef,omitempty" tf:"-"`

	// Selector for a Zone in dns to populate zoneNameOrId.
	// +kubebuilder:validation:Optional
	ZoneNameOrIDSelector *v1.NamespacedSelector `json:"zoneNameOrIdSelector,omitempty" tf:"-"`
}
