...
type SteeringPolicyInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	HealthCheckMonitorIDRef *v1.NamespacedReference `json:"healthCheckMonitorIdRef,omitempty" tf:"-"`

	// Selector for a HTTPMonitor in healthchecks to populate healthCheckMonitorId.
	// +kubebuilder:validation:Optional
	HealthCheckMonitorIDSelector *v1.NamespacedSelector `json:"healthCheckMonitorIdSelector,omitempty" tf:"-"`
