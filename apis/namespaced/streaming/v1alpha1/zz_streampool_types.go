...
type PrivateEndpointSettingsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	PrivateEndpointIPRef *v1.NamespacedReference `json:"privateEndpointIpRef,omitempty" tf:"-"`

	// Selector for a PrivateIp in networking to populate privateEndpointIp.
	// +kubebuilder:validation:Optional
	PrivateEndpointIPSelector *v1.NamespacedSelector `json:"privateEndpointIpSelector,omitempty" tf:"-"`
