...
type MigrationAssetInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ReplicationCompartmentIDRef *v1.NamespacedReference `json:"replicationCompartmentIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SnapShotBucketNameRef *v1.NamespacedReference `json:"snapShotBucketNameRef,omitempty" tf:"-"`
