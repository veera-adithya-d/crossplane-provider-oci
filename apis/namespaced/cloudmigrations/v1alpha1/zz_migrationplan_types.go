...
type MigrationPlanInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/cloudmigrations/v1alpha1.Migration
	...
	// +kubebuilder:validation:Optional
	MigrationIDRef *v1.NamespacedReference `json:"migrationIdRef,omitempty" tf:"-"`

	// Selector for a Migration in cloudmigrations to populate migrationId.
	// +kubebuilder:validation:Optional
	MigrationIDSelector *v1.NamespacedSelector `json:"migrationIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SourceMigrationPlanIDRef *v1.NamespacedReference `json:"sourceMigrationPlanIdRef,omitempty" tf:"-"`

	// Selector for a MigrationPlan in cloudmigrations to populate sourceMigrationPlanId.
	// +kubebuilder:validation:Optional
	SourceMigrationPlanIDSelector *v1.NamespacedSelector `json:"sourceMigrationPlanIdSelector,omitempty" tf:"-"`
