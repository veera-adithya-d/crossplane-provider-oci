...
type WebAppFirewallInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	WebAppFirewallPolicyIDRef *v1.NamespacedReference `json:"webAppFirewallPolicyIdRef,omitempty" tf:"-"`

	// Selector for a WebAppFirewallPolicy in waf to populate webAppFirewallPolicyId.
	// +kubebuilder:validation:Optional
	WebAppFirewallPolicyIDSelector *v1.NamespacedSelector `json:"webAppFirewallPolicyIdSelector,omitempty" tf:"-"`
}
