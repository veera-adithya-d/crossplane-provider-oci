...
type TargetTagsItemsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/identity/v1alpha1.TagNamespace
	...
	// +kubebuilder:validation:Optional
	TagNamespaceNameRef *v1.NamespacedReference `json:"tagNamespaceNameRef,omitempty" tf:"-"`

	// Selector for a TagNamespace in identity to populate tagNamespaceName.
	// +kubebuilder:validation:Optional
	TagNamespaceNameSelector *v1.NamespacedSelector `json:"tagNamespaceNameSelector,omitempty" tf:"-"`
