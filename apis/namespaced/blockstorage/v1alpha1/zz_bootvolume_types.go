...
type BootVolumeReplicasInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	XrrKMSKeyIDRef *v1.NamespacedReference `json:"xrrKmsKeyIdRef,omitempty" tf:"-"`

	// Selector for a Key in kms to populate xrrKmsKeyId.
	// +kubebuilder:validation:Optional
	XrrKMSKeyIDSelector *v1.NamespacedSelector `json:"xrrKmsKeyIdSelector,omitempty" tf:"-"`
}
...
type SourceDetailsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	FirstBackupIDRef *v1.NamespacedReference `json:"firstBackupIdRef,omitempty" tf:"-"`

	// Selector for a Backup in database to populate firstBackupId.
	// +kubebuilder:validation:Optional
	FirstBackupIDSelector *v1.NamespacedSelector `json:"firstBackupIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SecondBackupIDRef *v1.NamespacedReference `json:"secondBackupIdRef,omitempty" tf:"-"`

	// Selector for a Backup in database to populate secondBackupId.
	// +kubebuilder:validation:Optional
	SecondBackupIDSelector *v1.NamespacedSelector `json:"secondBackupIdSelector,omitempty" tf:"-"`
