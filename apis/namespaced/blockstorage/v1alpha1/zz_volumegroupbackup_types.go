...
type VolumeGroupBackupInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/blockstorage/v1alpha1.VolumeGroup
	...
	// +kubebuilder:validation:Optional
	VolumeGroupIDRef *v1.NamespacedReference `json:"volumeGroupIdRef,omitempty" tf:"-"`
