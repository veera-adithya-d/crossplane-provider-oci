...
type VolumeBackupPolicyAssignmentInitParameters struct {
	...
	AssetIDRef *v1.NamespacedReference `json:"assetIdRef,omitempty" tf:"-"`

	// Selector for a Volume in blockstorage to populate assetId.
	// +kubebuilder:validation:Optional
	AssetIDSelector *v1.NamespacedSelector `json:"assetIdSelector,omitempty" tf:"-"`

	// The OCID of the volume backup policy to assign to the volume.
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/blockstorage/v1alpha1.VolumeBackupPolicy
