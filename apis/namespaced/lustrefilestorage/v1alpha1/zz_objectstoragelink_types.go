...
type ObjectStorageLinkInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/lustrefilestorage/v1alpha1.LustreFileSystem
	...
	// +kubebuilder:validation:Optional
	LustreFileSystemIDRef *v1.NamespacedReference `json:"lustreFileSystemIdRef,omitempty" tf:"-"`

	// Selector for a LustreFileSystem in lustrefilestorage to populate lustreFileSystemId.
	// +kubebuilder:validation:Optional
	LustreFileSystemIDSelector *v1.NamespacedSelector `json:"lustreFileSystemIdSelector,omitempty" tf:"-"`
