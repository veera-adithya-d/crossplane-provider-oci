...
type SecurityAttributeInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/securityattribute/v1alpha1.SecurityAttributeNamespace
	...
	SecurityAttributeNamespaceIDRef *v1.NamespacedReference `json:"securityAttributeNamespaceIdRef,omitempty" tf:"-"`

	// Selector for a SecurityAttributeNamespace in securityattribute to populate securityAttributeNamespaceId.
	// +kubebuilder:validation:Optional
	SecurityAttributeNamespaceIDSelector *v1.NamespacedSelector `json:"securityAttributeNamespaceIdSelector,omitempty" tf:"-"`
