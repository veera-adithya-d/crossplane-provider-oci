...
type ExportInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/filestorage/v1alpha1.ExportSet
	...
	ExportSetIDRef *v1.NamespacedReference `json:"exportSetIdRef,omitempty" tf:"-"`

	// Selector for a ExportSet in filestorage to populate exportSetId.
	// +kubebuilder:validation:Optional
	ExportSetIDSelector *v1.NamespacedSelector `json:"exportSetIdSelector,omitempty" tf:"-"`
