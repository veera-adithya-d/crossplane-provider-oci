...
type KerberosInitParameters struct {
	...
	KeyTabSecretIDRef *v1.NamespacedReference `json:"keyTabSecretIdRef,omitempty" tf:"-"`

	// Selector for a Secret in vault to populate keyTabSecretId.
	// +kubebuilder:validation:Optional
	KeyTabSecretIDSelector *v1.NamespacedSelector `json:"keyTabSecretIdSelector,omitempty" tf:"-"`
}
