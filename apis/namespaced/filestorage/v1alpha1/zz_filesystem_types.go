...
type FileSystemInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/filestorage/v1alpha1.FilesystemSnapshotPolicy
	...
	// +kubebuilder:validation:Optional
	FilesystemSnapshotPolicyIDRef *v1.NamespacedReference `json:"filesystemSnapshotPolicyIdRef,omitempty" tf:"-"`

	// Selector for a FilesystemSnapshotPolicy in filestorage to populate filesystemSnapshotPolicyId.
	// +kubebuilder:validation:Optional
	FilesystemSnapshotPolicyIDSelector *v1.NamespacedSelector `json:"filesystemSnapshotPolicyIdSelector,omitempty" tf:"-"`
