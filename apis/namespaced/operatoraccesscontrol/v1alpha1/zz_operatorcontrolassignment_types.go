...
type OperatorControlAssignmentInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	OperatorControlIDRef *v1.NamespacedReference `json:"operatorControlIdRef,omitempty" tf:"-"`

	// Selector for a OperatorControl in operatoraccesscontrol to populate operatorControlId.
	// +kubebuilder:validation:Optional
	OperatorControlIDSelector *v1.NamespacedSelector `json:"operatorControlIdSelector,omitempty" tf:"-"`
