...
type AssetSourceInitParameters struct {
	...
	AssetsCompartmentIDRef *v1.NamespacedReference `json:"assetsCompartmentIdRef,omitempty" tf:"-"`

	// Selector for a Compartment in identity to populate assetsCompartmentId.
	// +kubebuilder:validation:Optional
	AssetsCompartmentIDSelector *v1.NamespacedSelector `json:"assetsCompartmentIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/cloudbridge/v1alpha1.DiscoverySchedule
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	DiscoveryScheduleIDRef *v1.NamespacedReference `json:"discoveryScheduleIdRef,omitempty" tf:"-"`

	// Selector for a DiscoverySchedule in cloudbridge to populate discoveryScheduleId.
	// +kubebuilder:validation:Optional
	DiscoveryScheduleIDSelector *v1.NamespacedSelector `json:"discoveryScheduleIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/cloudbridge/v1alpha1.Environment
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
