...
func (mg *NetworkLoadBalancersBackendSetsUnified) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this NetworkLoadBalancersBackendSetsUnified.
func (mg *NetworkLoadBalancersBackendSetsUnified) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}
...
func (mg *NetworkLoadBalancersBackendSetsUnified) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this NetworkLoadBalancersBackendSetsUnified.
func (mg *NetworkLoadBalancersBackendSetsUnified) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
	mg.Spec.WriteConnectionSecretToReference = r
}
