...
type BackendInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networkloadbalancer/v1alpha1.BackendSet
	...
	BackendSetNameRef *v1.NamespacedReference `json:"backendSetNameRef,omitempty" tf:"-"`

	// Selector for a BackendSet in networkloadbalancer to populate backendSetName.
	// +kubebuilder:validation:Optional
	BackendSetNameSelector *v1.NamespacedSelector `json:"backendSetNameSelector,omitempty" tf:"-"`
