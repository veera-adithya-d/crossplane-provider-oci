...
type IdentityProviderInitParameters struct {
	...
	Tags []IdentityProviderTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type IdentityProviderObservation struct {
	...
	IdcsCreatedBy []IdentityProviderIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []IdentityProviderIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []IdentityProviderMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []IdentityProviderTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type IdentityProviderParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []IdentityProviderTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type IdentityProviderTagsInitParameters struct {
...
type IdentityProviderTagsObservation struct {
...
type IdentityProviderTagsParameters struct {
...
type UrnietfparamsscimschemasoracleidcsextensionsocialIdentityProviderInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AppleKeyIDRef *v1.NamespacedReference `json:"appleKeyIdRef,omitempty" tf:"-"`

	// Selector for a Key in kms to populate appleKeyId.
	// +kubebuilder:validation:Optional
	AppleKeyIDSelector *v1.NamespacedSelector `json:"appleKeyIdSelector,omitempty" tf:"-"`
...
// IdentityProvider is the Schema for the IdentityProviders API. Provides the Identity Provider resource in Oracle Cloud Infrastructure Identity Domains service
