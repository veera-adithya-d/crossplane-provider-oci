...
type AppRoleAppInitParameters struct {
	...
	// App identifier
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/identitydomains/v1alpha1.App
	...
	// Selector for a App in identitydomains to populate value.
	// +kubebuilder:validation:Optional
	ValueSelector *v1.NamespacedSelector `json:"valueSelector,omitempty" tf:"-"`
}

type AppRoleAppObservation struct {
...
type AppRoleAppParameters struct {
...
type AppRoleIdcsCreatedByInitParameters struct {
}

type AppRoleIdcsCreatedByObservation struct {
...
type AppRoleIdcsCreatedByParameters struct {
}

type AppRoleIdcsLastModifiedByInitParameters struct {
}

type AppRoleIdcsLastModifiedByObservation struct {
...
type AppRoleIdcsLastModifiedByParameters struct {
}
...
type AppRoleInitParameters struct {
	...
	App []AppRoleAppInitParameters `json:"app,omitempty" tf:"app,omitempty"`
	...
	Tags []AppRoleTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type AppRoleMetaInitParameters struct {
}

type AppRoleMetaObservation struct {
...
type AppRoleMetaParameters struct {
}
...
type AppRoleObservation struct {
	...
	// A unique identifier for the application that references this role.
	App []AppRoleAppObservation `json:"app,omitempty" tf:"app,omitempty"`
	...
	IdcsCreatedBy []AppRoleIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []AppRoleIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []AppRoleMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// A list of tags on this resource.
	Tags []AppRoleTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type AppRoleParameters struct {
	...
	// A unique identifier for the application that references this role.
	// +kubebuilder:validation:Optional
	App []AppRoleAppParameters `json:"app,omitempty" tf:"app,omitempty"`
	...
	// A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []AppRoleTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type AppRoleTagsInitParameters struct {
...
type AppRoleTagsObservation struct {
...
type AppRoleTagsParameters struct {
...
// AppRole is the Schema for the AppRoles API. Provides the App Role resource in Oracle Cloud Infrastructure Identity Domains service
