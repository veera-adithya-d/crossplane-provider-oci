...
type KmsiSettingInitParameters struct {
	...
	// ID of the resource
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/identitydomains/v1alpha1.KmsiSetting
	...
	KmsiSettingIDRef *v1.NamespacedReference `json:"kmsiSettingIdRef,omitempty" tf:"-"`

	// Selector for a KmsiSetting in identitydomains to populate kmsiSettingId.
	// +kubebuilder:validation:Optional
	KmsiSettingIDSelector *v1.NamespacedSelector `json:"kmsiSettingIdSelector,omitempty" tf:"-"`
...
type KmsiSettingObservation struct {
	...
	IdcsCreatedBy []KmsiSettingIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []KmsiSettingIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []KmsiSettingTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type KmsiSettingParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []KmsiSettingTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type KmsiSettingTagsInitParameters struct {
...
type KmsiSettingTagsObservation struct {
...
type KmsiSettingTagsParameters struct {
...
// KmsiSettingSpec defines the desired state of KmsiSetting
type KmsiSettingSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            KmsiSettingParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider KmsiSettingInitParameters `json:"initProvider,omitempty"`
}

// KmsiSettingStatus defines the observed state of KmsiSetting.
type KmsiSettingStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        KmsiSettingObservation `json:"atProvider,omitempty"`
}
...
// KmsiSetting is the Schema for the KmsiSettings API. Provides the Kmsi Setting resource in Oracle Cloud Infrastructure Identity Domains service
...
type KmsiSetting struct {
	...
	Spec   KmsiSettingSpec   `json:"spec"`
	Status KmsiSettingStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// KmsiSettingList contains a list of KmsiSettings
type KmsiSettingList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []KmsiSetting `json:"items"`
}

// Repository type metadata.
var (
	KmsiSetting_Kind             = "KmsiSetting"
	KmsiSetting_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: KmsiSetting_Kind}.String()
	KmsiSetting_KindAPIVersion   = KmsiSetting_Kind + "." + CRDGroupVersion.String()
	KmsiSetting_GroupVersionKind = CRDGroupVersion.WithKind(KmsiSetting_Kind)
)

func init() {
	SchemeBuilder.Register(&KmsiSetting{}, &KmsiSettingList{})
}
