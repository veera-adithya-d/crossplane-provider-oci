...
type AuthenticationFactorSettingInitParameters struct {
	...
	// ID of the resource
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/identitydomains/v1alpha1.AuthenticationFactorSetting
	...
	AuthenticationFactorSettingIDRef *v1.NamespacedReference `json:"authenticationFactorSettingIdRef,omitempty" tf:"-"`

	// Selector for a AuthenticationFactorSetting in identitydomains to populate authenticationFactorSettingId.
	// +kubebuilder:validation:Optional
	AuthenticationFactorSettingIDSelector *v1.NamespacedSelector `json:"authenticationFactorSettingIdSelector,omitempty" tf:"-"`
	...
	Tags []AuthenticationFactorSettingTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type AuthenticationFactorSettingObservation struct {
	...
	IdcsCreatedBy []AuthenticationFactorSettingIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []AuthenticationFactorSettingIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []AuthenticationFactorSettingMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []AuthenticationFactorSettingTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type AuthenticationFactorSettingParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []AuthenticationFactorSettingTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type AuthenticationFactorSettingTagsInitParameters struct {
...
type AuthenticationFactorSettingTagsObservation struct {
...
type AuthenticationFactorSettingTagsParameters struct {
...
// AuthenticationFactorSettingSpec defines the desired state of AuthenticationFactorSetting
type AuthenticationFactorSettingSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            AuthenticationFactorSettingParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AuthenticationFactorSettingInitParameters `json:"initProvider,omitempty"`
}

// AuthenticationFactorSettingStatus defines the observed state of AuthenticationFactorSetting.
type AuthenticationFactorSettingStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AuthenticationFactorSettingObservation `json:"atProvider,omitempty"`
}
...
// AuthenticationFactorSetting is the Schema for the AuthenticationFactorSettings API. Provides the Authentication Factor Setting resource in Oracle Cloud Infrastructure Identity Domains service
...
type AuthenticationFactorSetting struct {
	...
	Spec   AuthenticationFactorSettingSpec   `json:"spec"`
	Status AuthenticationFactorSettingStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AuthenticationFactorSettingList contains a list of AuthenticationFactorSettings
type AuthenticationFactorSettingList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AuthenticationFactorSetting `json:"items"`
}

// Repository type metadata.
var (
	AuthenticationFactorSetting_Kind             = "AuthenticationFactorSetting"
	AuthenticationFactorSetting_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AuthenticationFactorSetting_Kind}.String()
	AuthenticationFactorSetting_KindAPIVersion   = AuthenticationFactorSetting_Kind + "." + CRDGroupVersion.String()
	AuthenticationFactorSetting_GroupVersionKind = CRDGroupVersion.WithKind(AuthenticationFactorSetting_Kind)
)

func init() {
	SchemeBuilder.Register(&AuthenticationFactorSetting{}, &AuthenticationFactorSettingList{})
}
