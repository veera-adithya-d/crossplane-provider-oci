...
type CloudGateMappingCloudGateObservation struct {
...
type CloudGateMappingCloudGateParameters struct {
...
type CloudGateMappingIdcsCreatedByInitParameters struct {
}

type CloudGateMappingIdcsCreatedByObservation struct {
...
type CloudGateMappingIdcsCreatedByParameters struct {
}

type CloudGateMappingIdcsLastModifiedByInitParameters struct {
}

type CloudGateMappingIdcsLastModifiedByObservation struct {
...
type CloudGateMappingIdcsLastModifiedByParameters struct {
}

type CloudGateMappingInitParameters struct {
	...
	CloudGate []CloudGateMappingCloudGateInitParameters `json:"cloudGate,omitempty" tf:"cloud_gate,omitempty"`
	...
	Tags []CloudGateMappingTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type CloudGateMappingMetaInitParameters struct {
}

type CloudGateMappingMetaObservation struct {
...
type CloudGateMappingMetaParameters struct {
}

type CloudGateMappingObservation struct {
	...
	// (Updatable) Reference to owning Cloud Gate
	CloudGate []CloudGateMappingCloudGateObservation `json:"cloudGate,omitempty" tf:"cloud_gate,omitempty"`
	...
	IdcsCreatedBy []CloudGateMappingIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []CloudGateMappingIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []CloudGateMappingMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []CloudGateMappingTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type CloudGateMappingParameters struct {
	...
	// (Updatable) Reference to owning Cloud Gate
	// +kubebuilder:validation:Optional
	CloudGate []CloudGateMappingCloudGateParameters `json:"cloudGate,omitempty" tf:"cloud_gate,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []CloudGateMappingTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type CloudGateMappingTagsInitParameters struct {
...
type CloudGateMappingTagsObservation struct {
...
type CloudGateMappingTagsParameters struct {
...
// CloudGateMappingSpec defines the desired state of CloudGateMapping
type CloudGateMappingSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            CloudGateMappingParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CloudGateMappingInitParameters `json:"initProvider,omitempty"`
}

// CloudGateMappingStatus defines the observed state of CloudGateMapping.
type CloudGateMappingStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CloudGateMappingObservation `json:"atProvider,omitempty"`
}
...
// CloudGateMapping is the Schema for the CloudGateMappings API. Provides the Cloud Gate Mapping resource in Oracle Cloud Infrastructure Identity Domains service
...
type CloudGateMapping struct {
	...
	Spec   CloudGateMappingSpec   `json:"spec"`
	Status CloudGateMappingStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CloudGateMappingList contains a list of CloudGateMappings
type CloudGateMappingList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CloudGateMapping `json:"items"`
}

// Repository type metadata.
var (
	CloudGateMapping_Kind             = "CloudGateMapping"
	CloudGateMapping_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CloudGateMapping_Kind}.String()
	CloudGateMapping_KindAPIVersion   = CloudGateMapping_Kind + "." + CRDGroupVersion.String()
	CloudGateMapping_GroupVersionKind = CRDGroupVersion.WithKind(CloudGateMapping_Kind)
)

func init() {
	SchemeBuilder.Register(&CloudGateMapping{}, &CloudGateMappingList{})
}
