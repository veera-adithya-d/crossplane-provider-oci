...
type SecurityQuestionSettingInitParameters struct {
	...
	// ID of the resource
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/identitydomains/v1alpha1.SecurityQuestionSetting
	...
	SecurityQuestionSettingIDRef *v1.NamespacedReference `json:"securityQuestionSettingIdRef,omitempty" tf:"-"`

	// Selector for a SecurityQuestionSetting in identitydomains to populate securityQuestionSettingId.
	// +kubebuilder:validation:Optional
	SecurityQuestionSettingIDSelector *v1.NamespacedSelector `json:"securityQuestionSettingIdSelector,omitempty" tf:"-"`

	// (Updatable) A list of tags on this resource.
	Tags []SecurityQuestionSettingTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}
...
type SecurityQuestionSettingObservation struct {
	...
	IdcsCreatedBy []SecurityQuestionSettingIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []SecurityQuestionSettingIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []SecurityQuestionSettingTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`

	// (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	TenancyOcid *string `json:"tenancyOcid,omitempty" tf:"tenancy_ocid,omitempty"`
}

type SecurityQuestionSettingParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []SecurityQuestionSettingTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type SecurityQuestionSettingTagsInitParameters struct {
...
type SecurityQuestionSettingTagsObservation struct {
...
type SecurityQuestionSettingTagsParameters struct {
...
// SecurityQuestionSettingSpec defines the desired state of SecurityQuestionSetting
type SecurityQuestionSettingSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            SecurityQuestionSettingParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SecurityQuestionSettingInitParameters `json:"initProvider,omitempty"`
}

// SecurityQuestionSettingStatus defines the observed state of SecurityQuestionSetting.
type SecurityQuestionSettingStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SecurityQuestionSettingObservation `json:"atProvider,omitempty"`
}
...
// SecurityQuestionSetting is the Schema for the SecurityQuestionSettings API. Provides the Security Question Setting resource in Oracle Cloud Infrastructure Identity Domains service
...
type SecurityQuestionSetting struct {
	...
	Spec   SecurityQuestionSettingSpec   `json:"spec"`
	Status SecurityQuestionSettingStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SecurityQuestionSettingList contains a list of SecurityQuestionSettings
type SecurityQuestionSettingList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SecurityQuestionSetting `json:"items"`
}

// Repository type metadata.
var (
	SecurityQuestionSetting_Kind             = "SecurityQuestionSetting"
	SecurityQuestionSetting_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SecurityQuestionSetting_Kind}.String()
	SecurityQuestionSetting_KindAPIVersion   = SecurityQuestionSetting_Kind + "." + CRDGroupVersion.String()
	SecurityQuestionSetting_GroupVersionKind = CRDGroupVersion.WithKind(SecurityQuestionSetting_Kind)
)

func init() {
	SchemeBuilder.Register(&SecurityQuestionSetting{}, &SecurityQuestionSettingList{})
}
