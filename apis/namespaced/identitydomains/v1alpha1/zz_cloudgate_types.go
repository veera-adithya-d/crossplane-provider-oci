...
type CloudGateInitParameters struct {
	...
	Tags []CloudGateTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type CloudGateObservation struct {
	...
	IdcsCreatedBy []CloudGateIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []CloudGateIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []CloudGateMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`

	// (Updatable) A reference to the OAuth client App used by this Cloud Gate instance.
	OauthClient []OauthClientObservation `json:"oauthClient,omitempty" tf:"oauth_client,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []CloudGateTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	UpstreamServerGroups []UpstreamServerGroupsObservation `json:"upstreamServerGroups,omitempty" tf:"upstream_server_groups,omitempty"`

	// (Updatable) A list of upstream servers
	UpstreamServers []UpstreamServersObservation `json:"upstreamServers,omitempty" tf:"upstream_servers,omitempty"`
}
...
type CloudGateParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []CloudGateTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type CloudGateTagsInitParameters struct {
...
type CloudGateTagsObservation struct {
...
type CloudGateTagsParameters struct {
...
type CloudGateSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            CloudGateParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CloudGateInitParameters `json:"initProvider,omitempty"`
}

// CloudGateStatus defines the observed state of CloudGate.
type CloudGateStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CloudGateObservation `json:"atProvider,omitempty"`
}
...
// CloudGate is the Schema for the CloudGates API. Provides the Cloud Gate resource in Oracle Cloud Infrastructure Identity Domains service
...
type CloudGate struct {
	...
	Spec   CloudGateSpec   `json:"spec"`
	Status CloudGateStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CloudGateList contains a list of CloudGates
type CloudGateList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CloudGate `json:"items"`
}

// Repository type metadata.
var (
	CloudGate_Kind             = "CloudGate"
	CloudGate_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CloudGate_Kind}.String()
	CloudGate_KindAPIVersion   = CloudGate_Kind + "." + CRDGroupVersion.String()
	CloudGate_GroupVersionKind = CRDGroupVersion.WithKind(CloudGate_Kind)
)

func init() {
	SchemeBuilder.Register(&CloudGate{}, &CloudGateList{})
}
