...
type PasswordPolicyInitParameters_2 struct {
	...
	PasswordStrengthSecretRef *v1.LocalSecretKeySelector `json:"passwordStrengthSecretRef,omitempty" tf:"-"`
	...
	Tags []PasswordPolicyTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type PasswordPolicyObservation_2 struct {
	...
	IdcsCreatedBy []PasswordPolicyIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []PasswordPolicyIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []PasswordPolicyTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type PasswordPolicyParameters_2 struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []PasswordPolicyTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type PasswordPolicyTagsInitParameters struct {
...
type PasswordPolicyTagsObservation struct {
...
type PasswordPolicyTagsParameters struct {
...
type PasswordPolicySpec struct {
	...
	ForProvider            PasswordPolicyParameters_2 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider PasswordPolicyInitParameters_2 `json:"initProvider,omitempty"`
}

// PasswordPolicyStatus defines the observed state of PasswordPolicy.
type PasswordPolicyStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        PasswordPolicyObservation_2 `json:"atProvider,omitempty"`
}
...
// PasswordPolicy is the Schema for the PasswordPolicys API. Provides the Password Policy resource in Oracle Cloud Infrastructure Identity Domains service
