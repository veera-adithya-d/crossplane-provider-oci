...
type AccountRecoverySettingInitParameters struct {
	...
	// ID of the resource
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/identitydomains/v1alpha1.AccountRecoverySetting
	...
	// Reference to a AccountRecoverySetting in identitydomains to populate accountRecoverySettingId.
	// +kubebuilder:validation:Optional
	AccountRecoverySettingIDRef *v1.NamespacedReference `json:"accountRecoverySettingIdRef,omitempty" tf:"-"`

	// Selector for a AccountRecoverySetting in identitydomains to populate accountRecoverySettingId.
	// +kubebuilder:validation:Optional
	AccountRecoverySettingIDSelector *v1.NamespacedSelector `json:"accountRecoverySettingIdSelector,omitempty" tf:"-"`
...
// AccountRecoverySettingSpec defines the desired state of AccountRecoverySetting
type AccountRecoverySettingSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            AccountRecoverySettingParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AccountRecoverySettingInitParameters `json:"initProvider,omitempty"`
}

// AccountRecoverySettingStatus defines the observed state of AccountRecoverySetting.
type AccountRecoverySettingStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AccountRecoverySettingObservation `json:"atProvider,omitempty"`
}
...
// AccountRecoverySetting is the Schema for the AccountRecoverySettings API. Provides the Account Recovery Setting resource in Oracle Cloud Infrastructure Identity Domains service
...
type AccountRecoverySetting struct {
	...
	Spec   AccountRecoverySettingSpec   `json:"spec"`
	Status AccountRecoverySettingStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AccountRecoverySettingList contains a list of AccountRecoverySettings
type AccountRecoverySettingList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AccountRecoverySetting `json:"items"`
}

// Repository type metadata.
var (
	AccountRecoverySetting_Kind             = "AccountRecoverySetting"
	AccountRecoverySetting_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AccountRecoverySetting_Kind}.String()
	AccountRecoverySetting_KindAPIVersion   = AccountRecoverySetting_Kind + "." + CRDGroupVersion.String()
	AccountRecoverySetting_GroupVersionKind = CRDGroupVersion.WithKind(AccountRecoverySetting_Kind)
)

func init() {
	SchemeBuilder.Register(&AccountRecoverySetting{}, &AccountRecoverySettingList{})
}
