...
type ManagedListInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/cloudguard/v1alpha1.ManagedList
	...
	// +kubebuilder:validation:Optional
	SourceManagedListIDRef *v1.NamespacedReference `json:"sourceManagedListIdRef,omitempty" tf:"-"`

	// Selector for a ManagedList in cloudguard to populate sourceManagedListId.
	// +kubebuilder:validation:Optional
	SourceManagedListIDSelector *v1.NamespacedSelector `json:"sourceManagedListIdSelector,omitempty" tf:"-"`
}
