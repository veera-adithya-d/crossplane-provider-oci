...
type KeyVersionInitParameters struct {
	...
	ExternalKeyVersionIDRef *v1.NamespacedReference `json:"externalKeyVersionIdRef,omitempty" tf:"-"`

	// Selector for a KeyVersion in kms to populate externalKeyVersionId.
	// +kubebuilder:validation:Optional
	ExternalKeyVersionIDSelector *v1.NamespacedSelector `json:"externalKeyVersionIdSelector,omitempty" tf:"-"`
