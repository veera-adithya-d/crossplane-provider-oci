...
type VerifyObservation struct {
	...
	IsSignatureValid *bool `json:"isSignatureValid,omitempty" tf:"is_signature_valid,omitempty"`
...
// Verify is the Schema for the Verifys API. Provides the Verify resource in Oracle Cloud Infrastructure Kms service
