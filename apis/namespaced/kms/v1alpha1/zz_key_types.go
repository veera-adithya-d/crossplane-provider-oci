...
type ExternalKeyReferenceInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ExternalKeyIDRef *v1.NamespacedReference `json:"externalKeyIdRef,omitempty" tf:"-"`

	// Selector for a Key in kms to populate externalKeyId.
	// +kubebuilder:validation:Optional
	ExternalKeyIDSelector *v1.NamespacedSelector `json:"externalKeyIdSelector,omitempty" tf:"-"`
}
