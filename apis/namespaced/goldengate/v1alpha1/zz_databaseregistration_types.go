...
type DatabaseRegistrationInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SecretCompartmentIDRef *v1.NamespacedReference `json:"secretCompartmentIdRef,omitempty" tf:"-"`

	// Selector for a Compartment in identity to populate secretCompartmentId.
	// +kubebuilder:validation:Optional
	SecretCompartmentIDSelector *v1.NamespacedSelector `json:"secretCompartmentIdSelector,omitempty" tf:"-"`
