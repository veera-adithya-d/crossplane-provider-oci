...
type CatalogInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ClientSecretSecretIDRef *v1.NamespacedReference `json:"clientSecretSecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	PropertiesSecretIDRef *v1.NamespacedReference `json:"propertiesSecretIdRef,omitempty" tf:"-"`
...
type ConnectionInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AccountKeySecretIDRef *v1.NamespacedReference `json:"accountKeySecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	JndiSecurityCredentialsSecretIDRef *v1.NamespacedReference `json:"jndiSecurityCredentialsSecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	KeyStorePasswordSecretIDRef *v1.NamespacedReference `json:"keyStorePasswordSecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	KeyStoreSecretIDRef *v1.NamespacedReference `json:"keyStoreSecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	PrivateKeyFileSecretIDRef *v1.NamespacedReference `json:"privateKeyFileSecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	PrivateKeyPassphraseSecretIDRef *v1.NamespacedReference `json:"privateKeyPassphraseSecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SSLClientKeystashSecretIDRef *v1.NamespacedReference `json:"sslClientKeystashSecretIdRef,omitempty" tf:"-"`

	// Selector for a Secret in vault to populate sslClientKeystashSecretId.
	// +kubebuilder:validation:Optional
	SSLClientKeystashSecretIDSelector *v1.NamespacedSelector `json:"sslClientKeystashSecretIdSelector,omitempty" tf:"-"`
	...
	SSLClientKeystashSecretRef *v1.LocalSecretKeySelector `json:"sslClientKeystashSecretRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SSLClientKeystoredbSecretIDRef *v1.NamespacedReference `json:"sslClientKeystoredbSecretIdRef,omitempty" tf:"-"`

	// Selector for a Secret in vault to populate sslClientKeystoredbSecretId.
	// +kubebuilder:validation:Optional
	SSLClientKeystoredbSecretIDSelector *v1.NamespacedSelector `json:"sslClientKeystoredbSecretIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SSLKeyPasswordSecretIDRef *v1.NamespacedReference `json:"sslKeyPasswordSecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SSLKeySecretIDRef *v1.NamespacedReference `json:"sslKeySecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SasTokenSecretIDRef *v1.NamespacedReference `json:"sasTokenSecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SecretAccessKeySecretIDRef *v1.NamespacedReference `json:"secretAccessKeySecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ServiceAccountKeyFileSecretIDRef *v1.NamespacedReference `json:"serviceAccountKeyFileSecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	StreamPoolIDRef *v1.NamespacedReference `json:"streamPoolIdRef,omitempty" tf:"-"`

	// Selector for a StreamPool in streaming to populate streamPoolId.
	// +kubebuilder:validation:Optional
	StreamPoolIDSelector *v1.NamespacedSelector `json:"streamPoolIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	TLSCertificateKeyFileSecretIDRef *v1.NamespacedReference `json:"tlsCertificateKeyFileSecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	TrustStorePasswordSecretIDRef *v1.NamespacedReference `json:"trustStorePasswordSecretIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	TrustStoreSecretIDRef *v1.NamespacedReference `json:"trustStoreSecretIdRef,omitempty" tf:"-"`
