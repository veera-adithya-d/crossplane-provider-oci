...
type AdbInitParameters struct {
	...
	AdminPasswordIDSecretRef v1.LocalSecretKeySelector `json:"adminPasswordIdSecretRef" tf:"-"`
...
type DBCredentialsInitParameters struct {
	...
	SecretIDSecretRef v1.LocalSecretKeySelector `json:"secretIdSecretRef" tf:"-"`
...
type GgcsConnectionsInitParameters struct {
	...
	GgAdminSecretIDSecretRef *v1.LocalSecretKeySelector `json:"ggAdminSecretIdSecretRef,omitempty" tf:"-"`
}
...
type GgcsInitParameters struct {
	...
	PasswordSecretIDSecretRef v1.LocalSecretKeySelector `json:"passwordSecretIdSecretRef" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	PublicSubnetIDRef *v1.NamespacedReference `json:"publicSubnetIdRef,omitempty" tf:"-"`

	// Selector for a Subnet in networking to populate publicSubnetId.
	// +kubebuilder:validation:Optional
	PublicSubnetIDSelector *v1.NamespacedSelector `json:"publicSubnetIdSelector,omitempty" tf:"-"`
