...
type MetricInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	MetricCompartmentIDRef *v1.NamespacedReference `json:"metricCompartmentIdRef,omitempty" tf:"-"`

	// Selector for a Compartment in identity to populate metricCompartmentId.
	// +kubebuilder:validation:Optional
	MetricCompartmentIDSelector *v1.NamespacedSelector `json:"metricCompartmentIdSelector,omitempty" tf:"-"`
