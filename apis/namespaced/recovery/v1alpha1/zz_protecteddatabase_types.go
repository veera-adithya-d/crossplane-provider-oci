...
type ProtectedDatabaseInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/recovery/v1alpha1.ProtectionPolicy
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	ProtectionPolicyIDRef *v1.NamespacedReference `json:"protectionPolicyIdRef,omitempty" tf:"-"`

	// Selector for a ProtectionPolicy in recovery to populate protectionPolicyId.
	// +kubebuilder:validation:Optional
	ProtectionPolicyIDSelector *v1.NamespacedSelector `json:"protectionPolicyIdSelector,omitempty" tf:"-"`
...
type RecoveryServiceSubnetsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/recovery/v1alpha1.RecoveryServiceSubnet
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	RecoveryServiceSubnetIDRef *v1.NamespacedReference `json:"recoveryServiceSubnetIdRef,omitempty" tf:"-"`

	// Selector for a RecoveryServiceSubnet in recovery to populate recoveryServiceSubnetId.
	// +kubebuilder:validation:Optional
	RecoveryServiceSubnetIDSelector *v1.NamespacedSelector `json:"recoveryServiceSubnetIdSelector,omitempty" tf:"-"`
}
