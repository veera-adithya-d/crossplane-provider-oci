...
type RemediationRecipeInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/adm/v1alpha1.KnowledgeBase
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
...
type ScmConfigurationInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	OciCodeRepositoryIDRef *v1.NamespacedReference `json:"ociCodeRepositoryIdRef,omitempty" tf:"-"`

	// Selector for a Repository in artifacts to populate ociCodeRepositoryId.
	// +kubebuilder:validation:Optional
	OciCodeRepositoryIDSelector *v1.NamespacedSelector `json:"ociCodeRepositoryIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	PatSecretIDRef *v1.NamespacedReference `json:"patSecretIdRef,omitempty" tf:"-"`

	// Selector for a Secret in vault to populate patSecretId.
	// +kubebuilder:validation:Optional
	PatSecretIDSelector *v1.NamespacedSelector `json:"patSecretIdSelector,omitempty" tf:"-"`
...
type VerifyConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/database/v1alpha1.MigrationJob
	...
	// +kubebuilder:validation:Optional
	TriggerSecretIDRef *v1.NamespacedReference `json:"triggerSecretIdRef,omitempty" tf:"-"`

	// Selector for a Secret in vault to populate triggerSecretId.
	// +kubebuilder:validation:Optional
	TriggerSecretIDSelector *v1.NamespacedSelector `json:"triggerSecretIdSelector,omitempty" tf:"-"`
