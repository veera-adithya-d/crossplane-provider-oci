...
type ResponseCacheDetailsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AuthenticationSecretIDRef *v1.NamespacedReference `json:"authenticationSecretIdRef,omitempty" tf:"-"`

	// Selector for a Secret in vault to populate authenticationSecretId.
	// +kubebuilder:validation:Optional
	AuthenticationSecretIDSelector *v1.NamespacedSelector `json:"authenticationSecretIdSelector,omitempty" tf:"-"`
