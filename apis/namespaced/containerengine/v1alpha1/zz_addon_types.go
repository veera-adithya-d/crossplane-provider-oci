...
type AddonInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/containerengine/v1alpha1.Addon
	...
	AddonNameRef *v1.NamespacedReference `json:"addonNameRef,omitempty" tf:"-"`

	// Selector for a Addon in containerengine to populate addonName.
	// +kubebuilder:validation:Optional
	AddonNameSelector *v1.NamespacedSelector `json:"addonNameSelector,omitempty" tf:"-"`
