...
func (tr *NodePool) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("NodeImageID"))
	opts = append(opts, resource.WithNameFilter("NodeImageName"))
	opts = append(opts, resource.WithNameFilter("SubnetIds"))
