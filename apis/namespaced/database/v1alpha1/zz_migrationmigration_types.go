...
type DataTransferMediumDetailsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SharedStorageMountTargetIDRef *v1.NamespacedReference `json:"sharedStorageMountTargetIdRef,omitempty" tf:"-"`

	// Selector for a MountTarget in filestorage to populate sharedStorageMountTargetId.
	// +kubebuilder:validation:Optional
	SharedStorageMountTargetIDSelector *v1.NamespacedSelector `json:"sharedStorageMountTargetIdSelector,omitempty" tf:"-"`
...
type MigrationMigrationInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceContainerDatabaseConnectionIDRef *v1.NamespacedReference `json:"sourceContainerDatabaseConnectionIdRef,omitempty" tf:"-"`

	// Selector for a MigrationConnection in database to populate sourceContainerDatabaseConnectionId.
	// +kubebuilder:validation:Optional
	SourceContainerDatabaseConnectionIDSelector *v1.NamespacedSelector `json:"sourceContainerDatabaseConnectionIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SourceDatabaseConnectionIDRef *v1.NamespacedReference `json:"sourceDatabaseConnectionIdRef,omitempty" tf:"-"`

	// Selector for a MigrationConnection in database to populate sourceDatabaseConnectionId.
	// +kubebuilder:validation:Optional
	SourceDatabaseConnectionIDSelector *v1.NamespacedSelector `json:"sourceDatabaseConnectionIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SourceStandbyDatabaseConnectionIDRef *v1.NamespacedReference `json:"sourceStandbyDatabaseConnectionIdRef,omitempty" tf:"-"`

	// Selector for a MigrationConnection in database to populate sourceStandbyDatabaseConnectionId.
	// +kubebuilder:validation:Optional
	SourceStandbyDatabaseConnectionIDSelector *v1.NamespacedSelector `json:"sourceStandbyDatabaseConnectionIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	TargetDatabaseConnectionIDRef *v1.NamespacedReference `json:"targetDatabaseConnectionIdRef,omitempty" tf:"-"`

	// Selector for a MigrationConnection in database to populate targetDatabaseConnectionId.
	// +kubebuilder:validation:Optional
	TargetDatabaseConnectionIDSelector *v1.NamespacedSelector `json:"targetDatabaseConnectionIdSelector,omitempty" tf:"-"`
