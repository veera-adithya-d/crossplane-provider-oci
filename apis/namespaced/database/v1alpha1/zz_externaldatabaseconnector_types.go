...
type ExternalDatabaseConnectorInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ExternalDatabaseIDRef *v1.NamespacedReference `json:"externalDatabaseIdRef,omitempty" tf:"-"`

	// Selector for a Database in database to populate externalDatabaseId.
	// +kubebuilder:validation:Optional
	ExternalDatabaseIDSelector *v1.NamespacedSelector `json:"externalDatabaseIdSelector,omitempty" tf:"-"`
