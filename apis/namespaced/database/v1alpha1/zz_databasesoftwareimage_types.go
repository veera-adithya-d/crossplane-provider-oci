...
type DatabaseSoftwareImageInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceDBHomeIDRef *v1.NamespacedReference `json:"sourceDbHomeIdRef,omitempty" tf:"-"`

	// Selector for a DbHome in database to populate sourceDbHomeId.
	// +kubebuilder:validation:Optional
	SourceDBHomeIDSelector *v1.NamespacedSelector `json:"sourceDbHomeIdSelector,omitempty" tf:"-"`
}
