...
type ManagementCloudClusterInstanceInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/database/v1alpha1.ManagementCloudClusterInstance
	...
	CloudClusterInstanceIDRef *v1.NamespacedReference `json:"cloudClusterInstanceIdRef,omitempty" tf:"-"`

	// Selector for a ManagementCloudClusterInstance in database to populate cloudClusterInstanceId.
	// +kubebuilder:validation:Optional
	CloudClusterInstanceIDSelector *v1.NamespacedSelector `json:"cloudClusterInstanceIdSelector,omitempty" tf:"-"`
