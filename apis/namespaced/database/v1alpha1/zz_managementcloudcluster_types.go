...
type ManagementCloudClusterInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/database/v1alpha1.ManagementCloudCluster
	...
	CloudClusterIDRef *v1.NamespacedReference `json:"cloudClusterIdRef,omitempty" tf:"-"`

	// Selector for a ManagementCloudCluster in database to populate cloudClusterId.
	// +kubebuilder:validation:Optional
	CloudClusterIDSelector *v1.NamespacedSelector `json:"cloudClusterIdSelector,omitempty" tf:"-"`
