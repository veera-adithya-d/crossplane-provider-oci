...
type ManagementExternalDbNodeInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/database/v1alpha1.ManagementExternalDbNode
	...
	ExternalDBNodeIDRef *v1.NamespacedReference `json:"externalDbNodeIdRef,omitempty" tf:"-"`

	// Selector for a ManagementExternalDbNode in database to populate externalDbNodeId.
	// +kubebuilder:validation:Optional
	ExternalDBNodeIDSelector *v1.NamespacedSelector `json:"externalDbNodeIdSelector,omitempty" tf:"-"`
