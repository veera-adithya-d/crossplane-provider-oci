...
type ManagementExternalExadataStorageGridInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/database/v1alpha1.ManagementExternalExadataStorageGrid
	...
	ExternalExadataStorageGridIDRef *v1.NamespacedReference `json:"externalExadataStorageGridIdRef,omitempty" tf:"-"`

	// Selector for a ManagementExternalExadataStorageGrid in database to populate externalExadataStorageGridId.
	// +kubebuilder:validation:Optional
	ExternalExadataStorageGridIDSelector *v1.NamespacedSelector `json:"externalExadataStorageGridIdSelector,omitempty" tf:"-"`
