...
type ScheduledActionInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SchedulingPlanIDRef *v1.NamespacedReference `json:"schedulingPlanIdRef,omitempty" tf:"-"`

	// Selector for a SchedulingPlan in database to populate schedulingPlanId.
	// +kubebuilder:validation:Optional
	SchedulingPlanIDSelector *v1.NamespacedSelector `json:"schedulingPlanIdSelector,omitempty" tf:"-"`
