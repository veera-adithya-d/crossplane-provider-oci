...
type ManagementExternalAsmInitParameters struct {
	...
	ExternalAsmIDRef *v1.NamespacedReference `json:"externalAsmIdRef,omitempty" tf:"-"`

	// Selector for a ManagementExternalAsm in database to populate externalAsmId.
	// +kubebuilder:validation:Optional
	ExternalAsmIDSelector *v1.NamespacedSelector `json:"externalAsmIdSelector,omitempty" tf:"-"`
