...
type DataGuardAssociationInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	PeerDBHomeIDRef *v1.NamespacedReference `json:"peerDbHomeIdRef,omitempty" tf:"-"`

	// Selector for a DbHome in database to populate peerDbHomeId.
	// +kubebuilder:validation:Optional
	PeerDBHomeIDSelector *v1.NamespacedSelector `json:"peerDbHomeIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	PeerVMClusterIDRef *v1.NamespacedReference `json:"peerVmClusterIdRef,omitempty" tf:"-"`

	// Selector for a VmCluster in database to populate peerVmClusterId.
	// +kubebuilder:validation:Optional
	PeerVMClusterIDSelector *v1.NamespacedSelector `json:"peerVmClusterIdSelector,omitempty" tf:"-"`
