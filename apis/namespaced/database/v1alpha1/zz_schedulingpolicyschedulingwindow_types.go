...
type SchedulingPolicySchedulingWindowInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/database/v1alpha1.SchedulingPolicy
	...
	// +kubebuilder:validation:Optional
	SchedulingPolicyIDRef *v1.NamespacedReference `json:"schedulingPolicyIdRef,omitempty" tf:"-"`

	// Selector for a SchedulingPolicy in database to populate schedulingPolicyId.
	// +kubebuilder:validation:Optional
	SchedulingPolicyIDSelector *v1.NamespacedSelector `json:"schedulingPolicyIdSelector,omitempty" tf:"-"`
