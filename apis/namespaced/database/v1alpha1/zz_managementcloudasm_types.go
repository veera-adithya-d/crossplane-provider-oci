...
type ManagementCloudAsmInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/database/v1alpha1.ManagementCloudAsm
	...
	CloudAsmIDRef *v1.NamespacedReference `json:"cloudAsmIdRef,omitempty" tf:"-"`

	// Selector for a ManagementCloudAsm in database to populate cloudAsmId.
	// +kubebuilder:validation:Optional
	CloudAsmIDSelector *v1.NamespacedSelector `json:"cloudAsmIdSelector,omitempty" tf:"-"`
