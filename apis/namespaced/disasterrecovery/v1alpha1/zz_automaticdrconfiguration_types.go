...
type AutomaticDrConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/disasterrecovery/v1alpha1.DrPlan
	...
	DefaultFailoverDrPlanIDRef *v1.NamespacedReference `json:"defaultFailoverDrPlanIdRef,omitempty" tf:"-"`

	// Selector for a DrPlan in disasterrecovery to populate defaultFailoverDrPlanId.
	// +kubebuilder:validation:Optional
	DefaultFailoverDrPlanIDSelector *v1.NamespacedSelector `json:"defaultFailoverDrPlanIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	DefaultSwitchoverDrPlanIDRef *v1.NamespacedReference `json:"defaultSwitchoverDrPlanIdRef,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/disasterrecovery/v1alpha1.DrProtectionGroup
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	DrProtectionGroupIDRef *v1.NamespacedReference `json:"drProtectionGroupIdRef,omitempty" tf:"-"`
