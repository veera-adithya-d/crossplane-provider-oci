...
type PatchTypeInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/fleetappsmanagement/v1alpha1.PlatformConfiguration
	...
	// +kubebuilder:validation:Optional
	PlatformConfigurationIDRef *v1.NamespacedReference `json:"platformConfigurationIdRef,omitempty" tf:"-"`

	// Selector for a PlatformConfiguration in fleetappsmanagement to populate platformConfigurationId.
	// +kubebuilder:validation:Optional
	PlatformConfigurationIDSelector *v1.NamespacedSelector `json:"platformConfigurationIdSelector,omitempty" tf:"-"`
}
