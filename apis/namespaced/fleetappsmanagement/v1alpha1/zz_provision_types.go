...
type ProvisionInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ConfigCatalogItemIDRef *v1.NamespacedReference `json:"configCatalogItemIdRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	PackageCatalogItemIDRef *v1.NamespacedReference `json:"packageCatalogItemIdRef,omitempty" tf:"-"`

	// Selector for a CatalogItem in fleetappsmanagement to populate packageCatalogItemId.
	// +kubebuilder:validation:Optional
	PackageCatalogItemIDSelector *v1.NamespacedSelector `json:"packageCatalogItemIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	TfVariableCompartmentIDRef *v1.NamespacedReference `json:"tfVariableCompartmentIdRef,omitempty" tf:"-"`

	// Selector for a Compartment in identity to populate tfVariableCompartmentId.
	// +kubebuilder:validation:Optional
	TfVariableCompartmentIDSelector *v1.NamespacedSelector `json:"tfVariableCompartmentIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	TfVariableCurrentUserIDRef *v1.NamespacedReference `json:"tfVariableCurrentUserIdRef,omitempty" tf:"-"`

	// Selector for a User in identity to populate tfVariableCurrentUserId.
	// +kubebuilder:validation:Optional
	TfVariableCurrentUserIDSelector *v1.NamespacedSelector `json:"tfVariableCurrentUserIdSelector,omitempty" tf:"-"`
