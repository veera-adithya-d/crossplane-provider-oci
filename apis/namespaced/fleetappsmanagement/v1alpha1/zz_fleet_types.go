...
type FleetInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ParentFleetIDRef *v1.NamespacedReference `json:"parentFleetIdRef,omitempty" tf:"-"`

	// Selector for a Fleet in fleetappsmanagement to populate parentFleetId.
	// +kubebuilder:validation:Optional
	ParentFleetIDSelector *v1.NamespacedSelector `json:"parentFleetIdSelector,omitempty" tf:"-"`
...
type RulesInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ResourceCompartmentIDRef *v1.NamespacedReference `json:"resourceCompartmentIdRef,omitempty" tf:"-"`

	// Selector for a Compartment in identity to populate resourceCompartmentId.
	// +kubebuilder:validation:Optional
	ResourceCompartmentIDSelector *v1.NamespacedSelector `json:"resourceCompartmentIdSelector,omitempty" tf:"-"`
}
