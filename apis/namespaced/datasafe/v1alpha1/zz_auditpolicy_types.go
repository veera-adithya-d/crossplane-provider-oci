...
type AuditPolicyInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/datasafe/v1alpha1.AuditPolicy
	...
	AuditPolicyIDRef *v1.NamespacedReference `json:"auditPolicyIdRef,omitempty" tf:"-"`

	// Selector for a AuditPolicy in datasafe to populate auditPolicyId.
	// +kubebuilder:validation:Optional
	AuditPolicyIDSelector *v1.NamespacedSelector `json:"auditPolicyIdSelector,omitempty" tf:"-"`
