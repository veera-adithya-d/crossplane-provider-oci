...
type AuditTrailInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/datasafe/v1alpha1.AuditTrail
	...
	AuditTrailIDRef *v1.NamespacedReference `json:"auditTrailIdRef,omitempty" tf:"-"`

	// Selector for a AuditTrail in datasafe to populate auditTrailId.
	// +kubebuilder:validation:Optional
	AuditTrailIDSelector *v1.NamespacedSelector `json:"auditTrailIdSelector,omitempty" tf:"-"`
