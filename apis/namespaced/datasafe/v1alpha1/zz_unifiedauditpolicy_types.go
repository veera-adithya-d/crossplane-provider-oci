...
type ConditionsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/datasafe/v1alpha1.AttributeSet
	...
	AttributeSetIDRef *v1.NamespacedReference `json:"attributeSetIdRef,omitempty" tf:"-"`

	// Selector for a AttributeSet in datasafe to populate attributeSetId.
	// +kubebuilder:validation:Optional
	AttributeSetIDSelector *v1.NamespacedSelector `json:"attributeSetIdSelector,omitempty" tf:"-"`
