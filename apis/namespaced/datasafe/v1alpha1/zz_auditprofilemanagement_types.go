...
type AuditProfileManagementAuditTrailsInitParameters struct {
}

type AuditProfileManagementAuditTrailsObservation struct {
...
type AuditProfileManagementAuditTrailsParameters struct {
}
...
type AuditProfileManagementObservation struct {
...
type AuditProfileManagementParameters struct {
...
// AuditProfileManagementSpec defines the desired state of AuditProfileManagement
type AuditProfileManagementSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            AuditProfileManagementParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AuditProfileManagementInitParameters `json:"initProvider,omitempty"`
}

// AuditProfileManagementStatus defines the observed state of AuditProfileManagement.
type AuditProfileManagementStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AuditProfileManagementObservation `json:"atProvider,omitempty"`
}
...
// AuditProfileManagement is the Schema for the AuditProfileManagements API. Provides the Audit Profile Management resource in Oracle Cloud Infrastructure Data Safe service
...
type AuditProfileManagement struct {
	...
	Spec   AuditProfileManagementSpec   `json:"spec"`
	Status AuditProfileManagementStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AuditProfileManagementList contains a list of AuditProfileManagements
type AuditProfileManagementList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AuditProfileManagement `json:"items"`
}

// Repository type metadata.
var (
	AuditProfileManagement_Kind             = "AuditProfileManagement"
	AuditProfileManagement_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AuditProfileManagement_Kind}.String()
	AuditProfileManagement_KindAPIVersion   = AuditProfileManagement_Kind + "." + CRDGroupVersion.String()
	AuditProfileManagement_GroupVersionKind = CRDGroupVersion.WithKind(AuditProfileManagement_Kind)
)

func init() {
	SchemeBuilder.Register(&AuditProfileManagement{}, &AuditProfileManagementList{})
}
