...
type SecurityAssessmentInitParameters struct {
	...
	BaseSecurityAssessmentIDRef *v1.NamespacedReference `json:"baseSecurityAssessmentIdRef,omitempty" tf:"-"`

	// Selector for a SecurityAssessment in datasafe to populate baseSecurityAssessmentId.
	// +kubebuilder:validation:Optional
	BaseSecurityAssessmentIDSelector *v1.NamespacedSelector `json:"baseSecurityAssessmentIdSelector,omitempty" tf:"-"`
