...
type SessionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/bastion/v1alpha1.Bastion
	...
	// +kubebuilder:validation:Optional
	BastionIDRef *v1.NamespacedReference `json:"bastionIdRef,omitempty" tf:"-"`

	// Selector for a Bastion in bastion to populate bastionId.
	// +kubebuilder:validation:Optional
	BastionIDSelector *v1.NamespacedSelector `json:"bastionIdSelector,omitempty" tf:"-"`
...
type TargetResourceDetailsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	TargetResourceOperatingSystemUserNameRef *v1.NamespacedReference `json:"targetResourceOperatingSystemUserNameRef,omitempty" tf:"-"`

	// Selector for a User in identity to populate targetResourceOperatingSystemUserName.
	// +kubebuilder:validation:Optional
	TargetResourceOperatingSystemUserNameSelector *v1.NamespacedSelector `json:"targetResourceOperatingSystemUserNameSelector,omitempty" tf:"-"`
