...
type BdsInstanceMetastoreConfigInitParameters struct {
	...
	BdsAPIKeyIDRef *v1.NamespacedReference `json:"bdsApiKeyIdRef,omitempty" tf:"-"`

	// Selector for a ApiKey in identity to populate bdsApiKeyId.
	// +kubebuilder:validation:Optional
	BdsAPIKeyIDSelector *v1.NamespacedSelector `json:"bdsApiKeyIdSelector,omitempty" tf:"-"`

	// (Updatable) Base-64 encoded passphrase of the BDS Api Key.
	BdsAPIKeyPassphraseSecretRef v1.LocalSecretKeySelector `json:"bdsApiKeyPassphraseSecretRef" tf:"-"`
