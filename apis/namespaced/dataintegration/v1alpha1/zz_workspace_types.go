...
type WorkspaceInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	EndpointCompartmentIDRef *v1.NamespacedReference `json:"endpointCompartmentIdRef,omitempty" tf:"-"`

	// Selector for a Compartment in identity to populate endpointCompartmentId.
	// +kubebuilder:validation:Optional
	EndpointCompartmentIDSelector *v1.NamespacedSelector `json:"endpointCompartmentIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	RegistryCompartmentIDRef *v1.NamespacedReference `json:"registryCompartmentIdRef,omitempty" tf:"-"`

	// Selector for a Compartment in identity to populate registryCompartmentId.
	// +kubebuilder:validation:Optional
	RegistryCompartmentIDSelector *v1.NamespacedSelector `json:"registryCompartmentIdSelector,omitempty" tf:"-"`
