...
type InstancePoolPlacementConfigurationsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	PrimarySubnetIDRef *v1.NamespacedReference `json:"primarySubnetIdRef,omitempty" tf:"-"`

	// Selector for a Subnet in networking to populate primarySubnetId.
	// +kubebuilder:validation:Optional
	PrimarySubnetIDSelector *v1.NamespacedSelector `json:"primarySubnetIdSelector,omitempty" tf:"-"`
