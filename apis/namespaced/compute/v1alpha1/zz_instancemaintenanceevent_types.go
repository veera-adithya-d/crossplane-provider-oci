...
type InstanceMaintenanceEventInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/compute/v1alpha1.InstanceMaintenanceEvent
	...
	InstanceMaintenanceEventIDRef *v1.NamespacedReference `json:"instanceMaintenanceEventIdRef,omitempty" tf:"-"`

	// Selector for a InstanceMaintenanceEvent in compute to populate instanceMaintenanceEventId.
	// +kubebuilder:validation:Optional
	InstanceMaintenanceEventIDSelector *v1.NamespacedSelector `json:"instanceMaintenanceEventIdSelector,omitempty" tf:"-"`
