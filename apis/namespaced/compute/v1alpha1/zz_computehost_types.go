...
type ComputeHostInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/compute/v1alpha1.ComputeHost
	...
	ComputeHostIDRef *v1.NamespacedReference `json:"computeHostIdRef,omitempty" tf:"-"`

	// Selector for a ComputeHost in compute to populate computeHostId.
	// +kubebuilder:validation:Optional
	ComputeHostIDSelector *v1.NamespacedSelector `json:"computeHostIdSelector,omitempty" tf:"-"`
}
