...
type ManagedInstanceInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	PrimaryManagementStationIDRef *v1.NamespacedReference `json:"primaryManagementStationIdRef,omitempty" tf:"-"`

	// Selector for a ManagementStation in osmanagementhub to populate primaryManagementStationId.
	// +kubebuilder:validation:Optional
	PrimaryManagementStationIDSelector *v1.NamespacedSelector `json:"primaryManagementStationIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SecondaryManagementStationIDRef *v1.NamespacedReference `json:"secondaryManagementStationIdRef,omitempty" tf:"-"`

	// Selector for a ManagementStation in osmanagementhub to populate secondaryManagementStationId.
	// +kubebuilder:validation:Optional
	SecondaryManagementStationIDSelector *v1.NamespacedSelector `json:"secondaryManagementStationIdSelector,omitempty" tf:"-"`
}
