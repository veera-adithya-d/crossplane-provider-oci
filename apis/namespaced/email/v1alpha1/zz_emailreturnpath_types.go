...
type EmailReturnPathInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/email/v1alpha1.EmailDomain
	...
	ParentResourceIDRef *v1.NamespacedReference `json:"parentResourceIdRef,omitempty" tf:"-"`

	// Selector for a EmailDomain in email to populate parentResourceId.
	// +kubebuilder:validation:Optional
	ParentResourceIDSelector *v1.NamespacedSelector `json:"parentResourceIdSelector,omitempty" tf:"-"`
}
