...
type CccInfrastructureInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/computecloudatcustomer/v1alpha1.CccUpgradeSchedule
	...
	CccUpgradeScheduleIDRef *v1.NamespacedReference `json:"cccUpgradeScheduleIdRef,omitempty" tf:"-"`

	// Selector for a CccUpgradeSchedule in computecloudatcustomer to populate cccUpgradeScheduleId.
	// +kubebuilder:validation:Optional
	CccUpgradeScheduleIDSelector *v1.NamespacedSelector `json:"cccUpgradeScheduleIdSelector,omitempty" tf:"-"`
