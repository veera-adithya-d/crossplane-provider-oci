...
type VtapInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/monitoring/v1alpha1.CaptureFilter
	...
	CaptureFilterIDRef *v1.NamespacedReference `json:"captureFilterIdRef,omitempty" tf:"-"`

	// Selector for a CaptureFilter in monitoring to populate captureFilterId.
	// +kubebuilder:validation:Optional
	CaptureFilterIDSelector *v1.NamespacedSelector `json:"captureFilterIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SourcePrivateEndpointSubnetIDRef *v1.NamespacedReference `json:"sourcePrivateEndpointSubnetIdRef,omitempty" tf:"-"`

	// Selector for a Subnet in networking to populate sourcePrivateEndpointSubnetId.
	// +kubebuilder:validation:Optional
	SourcePrivateEndpointSubnetIDSelector *v1.NamespacedSelector `json:"sourcePrivateEndpointSubnetIdSelector,omitempty" tf:"-"`
