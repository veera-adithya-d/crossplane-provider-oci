...
type MysqlConfigurationInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ParentConfigurationIDRef *v1.NamespacedReference `json:"parentConfigurationIdRef,omitempty" tf:"-"`

	// Selector for a Configuration in audit to populate parentConfigurationId.
	// +kubebuilder:validation:Optional
	ParentConfigurationIDSelector *v1.NamespacedSelector `json:"parentConfigurationIdSelector,omitempty" tf:"-"`
