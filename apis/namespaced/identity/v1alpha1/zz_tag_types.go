...
type TagInitParameters struct {
	...
	TagNamespaceIDRef *v1.NamespacedReference `json:"tagNamespaceIdRef,omitempty" tf:"-"`

	// Selector for a TagNamespace in identity to populate tagNamespaceId.
	// +kubebuilder:validation:Optional
	TagNamespaceIDSelector *v1.NamespacedSelector `json:"tagNamespaceIdSelector,omitempty" tf:"-"`
