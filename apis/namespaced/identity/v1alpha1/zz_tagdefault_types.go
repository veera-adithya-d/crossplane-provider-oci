...
type TagDefaultInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/identity/v1alpha1.Tag
	...
	// +kubebuilder:validation:Optional
	TagDefinitionIDRef *v1.NamespacedReference `json:"tagDefinitionIdRef,omitempty" tf:"-"`

	// Selector for a Tag in identity to populate tagDefinitionId.
	// +kubebuilder:validation:Optional
	TagDefinitionIDSelector *v1.NamespacedSelector `json:"tagDefinitionIdSelector,omitempty" tf:"-"`
