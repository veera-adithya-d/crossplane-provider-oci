...
type DomainInitParameters struct {
	...
	AdminUserNameRef *v1.NamespacedReference `json:"adminUserNameRef,omitempty" tf:"-"`

	// Selector for a User in identity to populate adminUserName.
	// +kubebuilder:validation:Optional
	AdminUserNameSelector *v1.NamespacedSelector `json:"adminUserNameSelector,omitempty" tf:"-"`
