...
type DrgRouteTableRouteRuleInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	NextHopDrgAttachmentIDRef *v1.NamespacedReference `json:"nextHopDrgAttachmentIdRef,omitempty" tf:"-"`

	// Selector for a DrgAttachment in networkconnectivity to populate nextHopDrgAttachmentId.
	// +kubebuilder:validation:Optional
	NextHopDrgAttachmentIDSelector *v1.NamespacedSelector `json:"nextHopDrgAttachmentIdSelector,omitempty" tf:"-"`
}
