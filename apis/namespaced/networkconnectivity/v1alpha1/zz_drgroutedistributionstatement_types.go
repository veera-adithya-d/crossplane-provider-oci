...
type DrgRouteDistributionStatementInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networkconnectivity/v1alpha1.DrgRouteDistribution
	...
	DrgRouteDistributionIDRef *v1.NamespacedReference `json:"drgRouteDistributionIdRef,omitempty" tf:"-"`

	// Selector for a DrgRouteDistribution in networkconnectivity to populate drgRouteDistributionId.
	// +kubebuilder:validation:Optional
	DrgRouteDistributionIDSelector *v1.NamespacedSelector `json:"drgRouteDistributionIdSelector,omitempty" tf:"-"`
...
type MatchCriteriaInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networkconnectivity/v1alpha1.DrgAttachment
	...
	// +kubebuilder:validation:Optional
	DrgAttachmentIDRef *v1.NamespacedReference `json:"drgAttachmentIdRef,omitempty" tf:"-"`

	// Selector for a DrgAttachment in networkconnectivity to populate drgAttachmentId.
	// +kubebuilder:validation:Optional
	DrgAttachmentIDSelector *v1.NamespacedSelector `json:"drgAttachmentIdSelector,omitempty" tf:"-"`
