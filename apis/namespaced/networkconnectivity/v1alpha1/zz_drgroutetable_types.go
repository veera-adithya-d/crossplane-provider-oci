...
type DrgRouteTableInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ImportDrgRouteDistributionIDRef *v1.NamespacedReference `json:"importDrgRouteDistributionIdRef,omitempty" tf:"-"`

	// Selector for a DrgRouteDistribution in networkconnectivity to populate importDrgRouteDistributionId.
	// +kubebuilder:validation:Optional
	ImportDrgRouteDistributionIDSelector *v1.NamespacedSelector `json:"importDrgRouteDistributionIdSelector,omitempty" tf:"-"`
