...
type IpsecInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networkconnectivity/v1alpha1.Cpe
	CpeID *string `json:"cpeId,omitempty" tf:"cpe_id,omitempty"`

	// Reference to a Cpe in networkconnectivity to populate cpeId.
	// +kubebuilder:validation:Optional
	CpeIDRef *v1.NamespacedReference `json:"cpeIdRef,omitempty" tf:"-"`

	// Selector for a Cpe in networkconnectivity to populate cpeId.
	// +kubebuilder:validation:Optional
	CpeIDSelector *v1.NamespacedSelector `json:"cpeIdSelector,omitempty" tf:"-"`
	...
	// The OCID of the DRG.
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networkconnectivity/v1alpha1.Drg
	DrgID *string `json:"drgId,omitempty" tf:"drg_id,omitempty"`

	// Reference to a Drg in networkconnectivity to populate drgId.
	// +kubebuilder:validation:Optional
	DrgIDRef *v1.NamespacedReference `json:"drgIdRef,omitempty" tf:"-"`

	// Selector for a Drg in networkconnectivity to populate drgId.
	// +kubebuilder:validation:Optional
	DrgIDSelector *v1.NamespacedSelector `json:"drgIdSelector,omitempty" tf:"-"`
...
type TunnelConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networkconnectivity/v1alpha1.VirtualCircuit
	...
	// +kubebuilder:validation:Optional
	AssociatedVirtualCircuitsRefs []v1.NamespacedReference `json:"associatedVirtualCircuitsRefs,omitempty" tf:"-"`

	// Selector for a list of VirtualCircuit in networkconnectivity to populate associatedVirtualCircuits.
	// +kubebuilder:validation:Optional
	AssociatedVirtualCircuitsSelector *v1.NamespacedSelector `json:"associatedVirtualCircuitsSelector,omitempty" tf:"-"`

	// The IPSec connection's Oracle ID (OCID).
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networkconnectivity/v1alpha1.DrgRouteTable
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	DrgRouteTableIDRef *v1.NamespacedReference `json:"drgRouteTableIdRef,omitempty" tf:"-"`

	// Selector for a DrgRouteTable in networkconnectivity to populate drgRouteTableId.
	// +kubebuilder:validation:Optional
	DrgRouteTableIDSelector *v1.NamespacedSelector `json:"drgRouteTableIdSelector,omitempty" tf:"-"`
