...
type IpsecConnectionTunnelManagementInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networkconnectivity/v1alpha1.Ipsec
	...
	// +kubebuilder:validation:Optional
	IpsecIDRef *v1.NamespacedReference `json:"ipsecIdRef,omitempty" tf:"-"`

	// Selector for a Ipsec in networkconnectivity to populate ipsecId.
	// +kubebuilder:validation:Optional
	IpsecIDSelector *v1.NamespacedSelector `json:"ipsecIdSelector,omitempty" tf:"-"`
