...
type RouteTableRouteRulesInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networking/v1alpha1.NatGateway
	...
	// +kubebuilder:validation:Optional
	NetworkEntityIDRef *v1.NamespacedReference `json:"networkEntityIdRef,omitempty" tf:"-"`

	// Selector for a NatGateway in networking to populate networkEntityId.
	// +kubebuilder:validation:Optional
	NetworkEntityIDSelector *v1.NamespacedSelector `json:"networkEntityIdSelector,omitempty" tf:"-"`
