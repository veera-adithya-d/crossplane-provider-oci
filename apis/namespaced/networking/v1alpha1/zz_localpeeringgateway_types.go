...
type LocalPeeringGatewayInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networking/v1alpha1.LocalPeeringGateway
	...
	// +kubebuilder:validation:Optional
	PeerIDRef *v1.NamespacedReference `json:"peerIdRef,omitempty" tf:"-"`

	// Selector for a LocalPeeringGateway in networking to populate peerId.
	// +kubebuilder:validation:Optional
	PeerIDSelector *v1.NamespacedSelector `json:"peerIdSelector,omitempty" tf:"-"`
