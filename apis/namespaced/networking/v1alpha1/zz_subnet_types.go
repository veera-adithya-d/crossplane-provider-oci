...
type SubnetInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networking/v1alpha1.DhcpOptions
	...
	// +kubebuilder:validation:Optional
	SecurityListIDRefs []v1.NamespacedReference `json:"securityListIdRefs,omitempty" tf:"-"`

	// Selector for a list of SecurityList in networking to populate securityListIds.
	// +kubebuilder:validation:Optional
	SecurityListIDSelector *v1.NamespacedSelector `json:"securityListIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networking/v1alpha1.SecurityList
