...
type PublicIpInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networking/v1alpha1.PublicIpPool
	...
	// +kubebuilder:validation:Optional
	PublicIPPoolIDRef *v1.NamespacedReference `json:"publicIpPoolIdRef,omitempty" tf:"-"`

	// Selector for a PublicIpPool in networking to populate publicIpPoolId.
	// +kubebuilder:validation:Optional
	PublicIPPoolIDSelector *v1.NamespacedSelector `json:"publicIpPoolIdSelector,omitempty" tf:"-"`
}
