...
type ModelGroupVersionHistoryInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	LatestModelGroupIDRef *v1.NamespacedReference `json:"latestModelGroupIdRef,omitempty" tf:"-"`

	// Selector for a ModelGroup in datascience to populate latestModelGroupId.
	// +kubebuilder:validation:Optional
	LatestModelGroupIDSelector *v1.NamespacedSelector `json:"latestModelGroupIdSelector,omitempty" tf:"-"`
