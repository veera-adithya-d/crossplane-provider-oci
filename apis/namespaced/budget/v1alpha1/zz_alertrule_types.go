...
type AlertRuleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/budget/v1alpha1.Budget
	...
	BudgetIDRef *v1.NamespacedReference `json:"budgetIdRef,omitempty" tf:"-"`

	// Selector for a Budget in budget to populate budgetId.
	// +kubebuilder:validation:Optional
	BudgetIDSelector *v1.NamespacedSelector `json:"budgetIdSelector,omitempty" tf:"-"`
