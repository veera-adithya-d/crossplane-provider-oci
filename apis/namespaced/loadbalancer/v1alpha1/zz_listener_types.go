...
type ListenerInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	DefaultBackendSetNameRef *v1.NamespacedReference `json:"defaultBackendSetNameRef,omitempty" tf:"-"`

	// Selector for a BackendSet in loadbalancer to populate defaultBackendSetName.
	// +kubebuilder:validation:Optional
	DefaultBackendSetNameSelector *v1.NamespacedSelector `json:"defaultBackendSetNameSelector,omitempty" tf:"-"`

	// (Updatable) An array of hostname resource names.
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/loadbalancer/v1alpha1.LBHostname
	...
	// +kubebuilder:validation:Optional
	HostnameNamesRefs []v1.NamespacedReference `json:"hostnameNamesRefs,omitempty" tf:"-"`

	// Selector for a list of LBHostname in loadbalancer to populate hostnameNames.
	// +kubebuilder:validation:Optional
	HostnameNamesSelector *v1.NamespacedSelector `json:"hostnameNamesSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/loadbalancer/v1alpha1.PathRouteSet
	...
	// +kubebuilder:validation:Optional
	PathRouteSetNameRef *v1.NamespacedReference `json:"pathRouteSetNameRef,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/loadbalancer/v1alpha1.RoutingPolicy
	...
	// +kubebuilder:validation:Optional
	RoutingPolicyNameRef *v1.NamespacedReference `json:"routingPolicyNameRef,omitempty" tf:"-"`

	// Selector for a RoutingPolicy in loadbalancer to populate routingPolicyName.
	// +kubebuilder:validation:Optional
	RoutingPolicyNameSelector *v1.NamespacedSelector `json:"routingPolicyNameSelector,omitempty" tf:"-"`

	// (Updatable) The names of the rule sets to apply to the listener.  Example: ["example_rule_set"]
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/loadbalancer/v1alpha1.RuleSet
	...
	// +kubebuilder:validation:Optional
	RuleSetNamesRefs []v1.NamespacedReference `json:"ruleSetNamesRefs,omitempty" tf:"-"`

	// Selector for a list of RuleSet in loadbalancer to populate ruleSetNames.
	// +kubebuilder:validation:Optional
	RuleSetNamesSelector *v1.NamespacedSelector `json:"ruleSetNamesSelector,omitempty" tf:"-"`
...
type ListenerSSLConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/loadbalancer/v1alpha1.Certificate
