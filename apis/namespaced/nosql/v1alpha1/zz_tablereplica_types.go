...
type TableReplicaInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	TableNameOrIDRef *v1.NamespacedReference `json:"tableNameOrIdRef,omitempty" tf:"-"`

	// Selector for a Table in nosql to populate tableNameOrId.
	// +kubebuilder:validation:Optional
	TableNameOrIDSelector *v1.NamespacedSelector `json:"tableNameOrIdSelector,omitempty" tf:"-"`
}
