...
type ScheduleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/datasafe/v1alpha1.Report
	...
	// +kubebuilder:validation:Optional
	SavedReportIDRef *v1.NamespacedReference `json:"savedReportIdRef,omitempty" tf:"-"`

	// Selector for a Report in datasafe to populate savedReportId.
	// +kubebuilder:validation:Optional
	SavedReportIDSelector *v1.NamespacedSelector `json:"savedReportIdSelector,omitempty" tf:"-"`
