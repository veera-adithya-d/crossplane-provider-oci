...
type ReplicationTargetsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	TargetVaultIDRef *v1.NamespacedReference `json:"targetVaultIdRef,omitempty" tf:"-"`

	// Selector for a Vault in kms to populate targetVaultId.
	// +kubebuilder:validation:Optional
	TargetVaultIDSelector *v1.NamespacedSelector `json:"targetVaultIdSelector,omitempty" tf:"-"`
}
...
type SecretInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SecretNameRef *v1.NamespacedReference `json:"secretNameRef,omitempty" tf:"-"`

	// Selector for a Secret in vault to populate secretName.
	// +kubebuilder:validation:Optional
	SecretNameSelector *v1.NamespacedSelector `json:"secretNameSelector,omitempty" tf:"-"`
