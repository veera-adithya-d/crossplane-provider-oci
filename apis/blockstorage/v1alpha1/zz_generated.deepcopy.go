...
func (in *BlockVolumeReplicasInitParameters) DeepCopyInto(out *BlockVolumeReplicasInitParameters) {
	*out = *in
	...
	if in.XrrKMSKeyIDRef != nil {
		in, out := &in.XrrKMSKeyIDRef, &out.XrrKMSKeyIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.XrrKMSKeyIDSelector != nil {
		in, out := &in.XrrKMSKeyIDSelector, &out.XrrKMSKeyIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *SourceDetailsInitParameters) DeepCopyInto(out *SourceDetailsInitParameters) {
	*out = *in
	...
	if in.FirstBackupIDRef != nil {
		in, out := &in.FirstBackupIDRef, &out.FirstBackupIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.FirstBackupIDSelector != nil {
		in, out := &in.FirstBackupIDSelector, &out.FirstBackupIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.ID != nil {
	...
	if in.SecondBackupIDRef != nil {
		in, out := &in.SecondBackupIDRef, &out.SecondBackupIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.SecondBackupIDSelector != nil {
		in, out := &in.SecondBackupIDSelector, &out.SecondBackupIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.Type != nil {
