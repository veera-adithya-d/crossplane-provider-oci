...
type ConditionIdcsCreatedByInitParameters struct {
}

type ConditionIdcsCreatedByObservation struct {
...
type ConditionIdcsCreatedByParameters struct {
}

type ConditionIdcsLastModifiedByInitParameters struct {
}

type ConditionIdcsLastModifiedByObservation struct {
...
type ConditionIdcsLastModifiedByParameters struct {
}
...
type ConditionInitParameters struct {
	...
	EvaluateConditionIf *string `json:"evaluateConditionIf,omitempty" tf:"evaluate_condition_if,omitempty"`
	...
	Tags []ConditionTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type ConditionMetaInitParameters struct {
}

type ConditionMetaObservation struct {
...
type ConditionMetaParameters struct {
}
...
type ConditionObservation struct {
	...
	IdcsCreatedBy []ConditionIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []ConditionIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []ConditionMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []ConditionTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type ConditionParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []ConditionTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type ConditionTagsInitParameters struct {
...
type ConditionTagsObservation struct {
...
type ConditionTagsParameters struct {
...
// Condition is the Schema for the Conditions API. Provides the Condition resource in Oracle Cloud Infrastructure Identity Domains service
