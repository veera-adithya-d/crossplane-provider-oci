...
type NetworkPerimeterIdcsCreatedByInitParameters struct {
}

type NetworkPerimeterIdcsCreatedByObservation struct {
...
type NetworkPerimeterIdcsCreatedByParameters struct {
}

type NetworkPerimeterIdcsLastModifiedByInitParameters struct {
}

type NetworkPerimeterIdcsLastModifiedByObservation struct {
...
type NetworkPerimeterIdcsLastModifiedByParameters struct {
}

type NetworkPerimeterInitParameters struct {
	...
	Tags []NetworkPerimeterTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type NetworkPerimeterMetaInitParameters struct {
}

type NetworkPerimeterMetaObservation struct {
...
type NetworkPerimeterMetaParameters struct {
}

type NetworkPerimeterObservation struct {
	...
	IdcsCreatedBy []NetworkPerimeterIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []NetworkPerimeterIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []NetworkPerimeterMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []NetworkPerimeterTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`

	// (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	TenancyOcid *string `json:"tenancyOcid,omitempty" tf:"tenancy_ocid,omitempty"`
}

type NetworkPerimeterParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []NetworkPerimeterTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type NetworkPerimeterTagsInitParameters struct {
...
type NetworkPerimeterTagsObservation struct {
...
type NetworkPerimeterTagsParameters struct {
...
// NetworkPerimeterSpec defines the desired state of NetworkPerimeter
type NetworkPerimeterSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     NetworkPerimeterParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider NetworkPerimeterInitParameters `json:"initProvider,omitempty"`
}

// NetworkPerimeterStatus defines the observed state of NetworkPerimeter.
type NetworkPerimeterStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        NetworkPerimeterObservation `json:"atProvider,omitempty"`
}
...
// NetworkPerimeter is the Schema for the NetworkPerimeters API. Provides the Network Perimeter resource in Oracle Cloud Infrastructure Identity Domains service
...
type NetworkPerimeter struct {
	...
	Spec   NetworkPerimeterSpec   `json:"spec"`
	Status NetworkPerimeterStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// NetworkPerimeterList contains a list of NetworkPerimeters
type NetworkPerimeterList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []NetworkPerimeter `json:"items"`
}

// Repository type metadata.
var (
	NetworkPerimeter_Kind             = "NetworkPerimeter"
	NetworkPerimeter_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: NetworkPerimeter_Kind}.String()
	NetworkPerimeter_KindAPIVersion   = NetworkPerimeter_Kind + "." + CRDGroupVersion.String()
	NetworkPerimeter_GroupVersionKind = CRDGroupVersion.WithKind(NetworkPerimeter_Kind)
)

func init() {
	SchemeBuilder.Register(&NetworkPerimeter{}, &NetworkPerimeterList{})
}
