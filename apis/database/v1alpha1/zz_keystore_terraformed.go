...
func (tr *KeyStore) GetObservation() (map[string]any, error) {
...
func (tr *KeyStore) SetObservation(obs map[string]any) error {
...
func (tr *KeyStore) GetParameters() (map[string]any, error) {
...
func (tr *KeyStore) SetParameters(params map[string]any) error {
...
// GetInitParameters of this KeyStore
func (tr *KeyStore) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this KeyStore
func (tr *KeyStore) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
