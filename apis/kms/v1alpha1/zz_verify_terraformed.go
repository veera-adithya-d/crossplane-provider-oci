...
// GetInitParameters of this Verify
func (tr *Verify) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Verify
func (tr *Verify) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
