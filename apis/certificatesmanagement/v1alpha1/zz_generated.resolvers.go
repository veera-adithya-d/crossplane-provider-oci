...
// ResolveReferences of this ManagementCaBundle.
func (mg *ManagementCaBundle) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this ManagementCertificate.
func (mg *ManagementCertificate) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
