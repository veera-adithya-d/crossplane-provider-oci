...
type ManagementCertificateInitParameters struct {
...
type ManagementCertificateObservation struct {
	...
	// The subject of the certificate, which is a distinguished name that identifies the entity that owns the public key in the certificate.
	Subject []ManagementCertificateSubjectObservation `json:"subject,omitempty" tf:"subject,omitempty"`
...
type ManagementCertificateSubjectInitParameters struct {
}

type ManagementCertificateSubjectObservation struct {
...
type ManagementCertificateSubjectParameters struct {
}
...
type ManagementCertificateSpec struct {
	...
	// autoscaler.
	InitProvider ManagementCertificateInitParameters `json:"initProvider,omitempty"`
}
...
// ManagementCertificate is the Schema for the ManagementCertificates API. Provides the Certificate resource in Oracle Cloud Infrastructure Certificates Management service
