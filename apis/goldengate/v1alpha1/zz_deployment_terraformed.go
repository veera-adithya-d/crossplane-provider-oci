...
func (mg *Deployment) GetTerraformResourceType() string {
	return "oci_golden_gate_deployment"
}

// GetConnectionDetailsMapping for this Deployment
func (tr *Deployment) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"ogg_data[*].admin_password": "oggData[*].adminPasswordSecretRef", "ogg_data[*].password_secret_id": "oggData[*].passwordSecretIdSecretRef"}
}
