...
func (mg *Stack) GetTerraformResourceType() string {
	return "oci_dif_stack"
}

// GetConnectionDetailsMapping for this Stack
func (tr *Stack) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"adb[*].admin_password_id": "adb[*].adminPasswordIdSecretRef", "adb[*].db_credentials[*].secret_id": "adb[*].dbCredentials[*].secretIdSecretRef", "ggcs[*].connections[*].gg_admin_secret_id": "ggcs[*].connections[*].ggAdminSecretIdSecretRef", "ggcs[*].password_secret_id": "ggcs[*].passwordSecretIdSecretRef", "ggcs[*].users[*].secret_id": "ggcs[*].users[*].secretIdSecretRef"}
}
