...
// GetInitParameters of this PathRouteSet
func (tr *PathRouteSet) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this PathRouteSet
func (tr *PathRouteSet) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
