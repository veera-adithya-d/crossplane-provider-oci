...
type ListenerInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/loadbalancer/v1alpha1.LBHostname
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/loadbalancer/v1alpha1.PathRouteSet
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/loadbalancer/v1alpha1.RoutingPolicy
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/loadbalancer/v1alpha1.RuleSet
...
type ListenerSSLConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/loadbalancer/v1alpha1.Certificate
