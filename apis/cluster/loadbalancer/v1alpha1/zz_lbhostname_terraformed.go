...
// GetInitParameters of this LBHostname
func (tr *LBHostname) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LBHostname
func (tr *LBHostname) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
