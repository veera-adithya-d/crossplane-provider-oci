...
type FusionEnvironmentInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	FusionEnvironmentFamilyIDRef *v1.Reference `json:"fusionEnvironmentFamilyIdRef,omitempty" tf:"-"`

	// Selector for a FusionEnvironmentFamily in fusionapps to populate fusionEnvironmentFamilyId.
	// +kubebuilder:validation:Optional
	FusionEnvironmentFamilyIDSelector *v1.Selector `json:"fusionEnvironmentFamilyIdSelector,omitempty" tf:"-"`
