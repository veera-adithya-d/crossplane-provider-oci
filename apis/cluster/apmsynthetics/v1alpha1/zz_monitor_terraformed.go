...
func (mg *Monitor) GetTerraformResourceType() string {
	return "oci_apm_synthetics_monitor"
}

// GetConnectionDetailsMapping for this Monitor
func (tr *Monitor) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"configuration[*].database_authentication_details[*].password[*].password": "configuration[*].databaseAuthenticationDetails[*].password[*].passwordSecretRef", "configuration[*].database_authentication_details[*].password[*].password_type": "configuration[*].databaseAuthenticationDetails[*].password[*].passwordTypeSecretRef", "configuration[*].ftp_basic_authentication_details[*].password[*].password": "configuration[*].ftpBasicAuthenticationDetails[*].password[*].passwordSecretRef", "configuration[*].ftp_basic_authentication_details[*].password[*].password_type": "configuration[*].ftpBasicAuthenticationDetails[*].password[*].passwordTypeSecretRef", "configuration[*].req_authentication_details[*].auth_user_password": "configuration[*].reqAuthenticationDetails[*].authUserPasswordSecretRef"}
}
