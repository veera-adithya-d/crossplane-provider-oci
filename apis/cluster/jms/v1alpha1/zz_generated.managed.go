...
// GetDeletionPolicy of this FleetAgentConfiguration.
func (mg *FleetAgentConfiguration) GetDeletionPolicy() xpv1.DeletionPolicy {
	return mg.Spec.DeletionPolicy
}
...
func (mg *FleetAgentConfiguration) GetWriteConnectionSecretToReference() *xpv1.SecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}
...
// SetDeletionPolicy of this FleetAgentConfiguration.
func (mg *FleetAgentConfiguration) SetDeletionPolicy(r xpv1.DeletionPolicy) {
	mg.Spec.DeletionPolicy = r
}
...
func (mg *FleetAgentConfiguration) SetProviderConfigReference(r *xpv1.Reference) {
	mg.Spec.ProviderConfigReference = r
}
...
// GetDeletionPolicy of this JmsPlugin.
func (mg *JmsPlugin) GetDeletionPolicy() xpv1.DeletionPolicy {
	return mg.Spec.DeletionPolicy
}
...
func (mg *JmsPlugin) GetWriteConnectionSecretToReference() *xpv1.SecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}
...
// SetDeletionPolicy of this JmsPlugin.
func (mg *JmsPlugin) SetDeletionPolicy(r xpv1.DeletionPolicy) {
	mg.Spec.DeletionPolicy = r
}
...
func (mg *JmsPlugin) SetProviderConfigReference(r *xpv1.Reference) {
	mg.Spec.ProviderConfigReference = r
}
