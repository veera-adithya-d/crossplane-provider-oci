...
type ComponentsGoalVersionDetailsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	GoalSoftwareImageIDRef *v1.Reference `json:"goalSoftwareImageIdRef,omitempty" tf:"-"`

	// Selector for a Image in compute to populate goalSoftwareImageId.
	// +kubebuilder:validation:Optional
	GoalSoftwareImageIDSelector *v1.Selector `json:"goalSoftwareImageIdSelector,omitempty" tf:"-"`
...
type FsuCycleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/fleetsoftwareupdate/v1alpha1.FsuCollection
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	FsuCollectionIDRef *v1.Reference `json:"fsuCollectionIdRef,omitempty" tf:"-"`

	// Selector for a FsuCollection in fleetsoftwareupdate to populate fsuCollectionId.
	// +kubebuilder:validation:Optional
	FsuCollectionIDSelector *v1.Selector `json:"fsuCollectionIdSelector,omitempty" tf:"-"`
...
type GoalVersionDetailsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SoftwareImageIDRef *v1.Reference `json:"softwareImageIdRef,omitempty" tf:"-"`

	// Selector for a Image in compute to populate softwareImageId.
	// +kubebuilder:validation:Optional
	SoftwareImageIDSelector *v1.Selector `json:"softwareImageIdSelector,omitempty" tf:"-"`
