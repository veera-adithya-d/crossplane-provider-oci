...
type ResourceActionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/optimizer/v1alpha1.ResourceAction
	...
	ResourceActionIDRef *v1.Reference `json:"resourceActionIdRef,omitempty" tf:"-"`

	// Selector for a ResourceAction in optimizer to populate resourceActionId.
	// +kubebuilder:validation:Optional
	ResourceActionIDSelector *v1.Selector `json:"resourceActionIdSelector,omitempty" tf:"-"`
