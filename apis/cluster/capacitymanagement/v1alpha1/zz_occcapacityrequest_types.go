...
type OccCapacityRequestInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/capacitymanagement/v1alpha1.OccAvailabilityCatalog
	...
	// +kubebuilder:validation:Optional
	OccAvailabilityCatalogIDRef *v1.Reference `json:"occAvailabilityCatalogIdRef,omitempty" tf:"-"`

	// Selector for a OccAvailabilityCatalog in capacitymanagement to populate occAvailabilityCatalogId.
	// +kubebuilder:validation:Optional
	OccAvailabilityCatalogIDSelector *v1.Selector `json:"occAvailabilityCatalogIdSelector,omitempty" tf:"-"`
