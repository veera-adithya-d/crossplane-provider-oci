...
func (tr *AlertRule) GetObservation() (map[string]any, error) {
...
func (tr *AlertRule) SetObservation(obs map[string]any) error {
...
func (tr *AlertRule) GetParameters() (map[string]any, error) {
...
func (tr *AlertRule) SetParameters(params map[string]any) error {
...
// GetInitParameters of this AlertRule
func (tr *AlertRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AlertRule
func (tr *AlertRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
