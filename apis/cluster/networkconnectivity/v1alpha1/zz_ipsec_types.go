...
type IpsecInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/networkconnectivity/v1alpha1.Cpe
	...
	// The OCID of the DRG.
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/networkconnectivity/v1alpha1.Drg
...
type TunnelConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/networkconnectivity/v1alpha1.VirtualCircuit
	...
	// +kubebuilder:validation:Optional
	AssociatedVirtualCircuitsRefs []v1.Reference `json:"associatedVirtualCircuitsRefs,omitempty" tf:"-"`

	// Selector for a list of VirtualCircuit in networkconnectivity to populate associatedVirtualCircuits.
	// +kubebuilder:validation:Optional
	AssociatedVirtualCircuitsSelector *v1.Selector `json:"associatedVirtualCircuitsSelector,omitempty" tf:"-"`

	// The IPSec connection's Oracle ID (OCID).
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/networkconnectivity/v1alpha1.DrgRouteTable
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
