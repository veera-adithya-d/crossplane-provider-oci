...
type ClusterInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/ocvp/v1alpha1.Sddc
	...
	SddcIDRef *v1.Reference `json:"sddcIdRef,omitempty" tf:"-"`

	// Selector for a Sddc in ocvp to populate sddcId.
	// +kubebuilder:validation:Optional
	SddcIDSelector *v1.Selector `json:"sddcIdSelector,omitempty" tf:"-"`
