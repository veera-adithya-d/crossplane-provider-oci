...
type InitialClusterConfigurationsClusterByolAllocationDetailsInitParameters struct {
	...
	FirewallByolAllocationIDRef *v1.Reference `json:"firewallByolAllocationIdRef,omitempty" tf:"-"`

	// Selector for a ByolAllocation in ocvp to populate firewallByolAllocationId.
	// +kubebuilder:validation:Optional
	FirewallByolAllocationIDSelector *v1.Selector `json:"firewallByolAllocationIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	VsanByolAllocationIDRef *v1.Reference `json:"vsanByolAllocationIdRef,omitempty" tf:"-"`

	// Selector for a ByolAllocation in ocvp to populate vsanByolAllocationId.
	// +kubebuilder:validation:Optional
	VsanByolAllocationIDSelector *v1.Selector `json:"vsanByolAllocationIdSelector,omitempty" tf:"-"`
}

type InitialClusterConfigurationsClusterByolAllocationDetailsObservation struct {
...
type InitialClusterConfigurationsClusterByolAllocationDetailsParameters struct {
...
type InitialClusterConfigurationsInitParameters struct {
	...
	ClusterByolAllocationDetails []InitialClusterConfigurationsClusterByolAllocationDetailsInitParameters `json:"clusterByolAllocationDetails,omitempty" tf:"cluster_byol_allocation_details,omitempty"`
	...
	// +kubebuilder:validation:Optional
	InitialVcfByolAllocationIDRef *v1.Reference `json:"initialVcfByolAllocationIdRef,omitempty" tf:"-"`

	// Selector for a ByolAllocation in ocvp to populate initialVcfByolAllocationId.
	// +kubebuilder:validation:Optional
	InitialVcfByolAllocationIDSelector *v1.Selector `json:"initialVcfByolAllocationIdSelector,omitempty" tf:"-"`
...
type InitialClusterConfigurationsNetworkConfigurationInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	HcxVlanIDRef *v1.Reference `json:"hcxVlanIdRef,omitempty" tf:"-"`

	// Selector for a Vlan in networking to populate hcxVlanId.
	// +kubebuilder:validation:Optional
	HcxVlanIDSelector *v1.Selector `json:"hcxVlanIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	NsxEdgeVtepVlanIDRef *v1.Reference `json:"nsxEdgeVtepVlanIdRef,omitempty" tf:"-"`

	// Selector for a Vlan in networking to populate nsxEdgeVtepVlanId.
	// +kubebuilder:validation:Optional
	NsxEdgeVtepVlanIDSelector *v1.Selector `json:"nsxEdgeVtepVlanIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	NsxVtepVlanIDRef *v1.Reference `json:"nsxVtepVlanIdRef,omitempty" tf:"-"`

	// Selector for a Vlan in networking to populate nsxVtepVlanId.
	// +kubebuilder:validation:Optional
	NsxVtepVlanIDSelector *v1.Selector `json:"nsxVtepVlanIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ProvisioningSubnetIDRef *v1.Reference `json:"provisioningSubnetIdRef,omitempty" tf:"-"`

	// Selector for a Subnet in networking to populate provisioningSubnetId.
	// +kubebuilder:validation:Optional
	ProvisioningSubnetIDSelector *v1.Selector `json:"provisioningSubnetIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ProvisioningVlanIDRef *v1.Reference `json:"provisioningVlanIdRef,omitempty" tf:"-"`

	// Selector for a Vlan in networking to populate provisioningVlanId.
	// +kubebuilder:validation:Optional
	ProvisioningVlanIDSelector *v1.Selector `json:"provisioningVlanIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ReplicationVlanIDRef *v1.Reference `json:"replicationVlanIdRef,omitempty" tf:"-"`

	// Selector for a Vlan in networking to populate replicationVlanId.
	// +kubebuilder:validation:Optional
	ReplicationVlanIDSelector *v1.Selector `json:"replicationVlanIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	VmotionVlanIDRef *v1.Reference `json:"vmotionVlanIdRef,omitempty" tf:"-"`

	// Selector for a Vlan in networking to populate vmotionVlanId.
	// +kubebuilder:validation:Optional
	VmotionVlanIDSelector *v1.Selector `json:"vmotionVlanIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	VsanVlanIDRef *v1.Reference `json:"vsanVlanIdRef,omitempty" tf:"-"`

	// Selector for a Vlan in networking to populate vsanVlanId.
	// +kubebuilder:validation:Optional
	VsanVlanIDSelector *v1.Selector `json:"vsanVlanIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	VsphereVlanIDRef *v1.Reference `json:"vsphereVlanIdRef,omitempty" tf:"-"`

	// Selector for a Vlan in networking to populate vsphereVlanId.
	// +kubebuilder:validation:Optional
	VsphereVlanIDSelector *v1.Selector `json:"vsphereVlanIdSelector,omitempty" tf:"-"`
}
...
type InitialClusterConfigurationsObservation struct {
	...
	// The BYOL allocations used for VMware Cluster provisioning.
	ClusterByolAllocationDetails []InitialClusterConfigurationsClusterByolAllocationDetailsObservation `json:"clusterByolAllocationDetails,omitempty" tf:"cluster_byol_allocation_details,omitempty"`
...
type InitialClusterConfigurationsParameters struct {
	...
	// The BYOL allocations used for VMware Cluster provisioning.
	// +kubebuilder:validation:Optional
	ClusterByolAllocationDetails []InitialClusterConfigurationsClusterByolAllocationDetailsParameters `json:"clusterByolAllocationDetails,omitempty" tf:"cluster_byol_allocation_details,omitempty"`
...
type SddcByolAllocationDetailsInitParameters struct {

	// (Updatable) The OCID of the VMware BYOL Allocation used to deploy VMware Avi Load Balancer.
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/ocvp/v1alpha1.ByolAllocation
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// Reference to a ByolAllocation in ocvp to populate loadBalancerByolAllocationId.
	// +kubebuilder:validation:Optional
	LoadBalancerByolAllocationIDRef *v1.Reference `json:"loadBalancerByolAllocationIdRef,omitempty" tf:"-"`

	// Selector for a ByolAllocation in ocvp to populate loadBalancerByolAllocationId.
	// +kubebuilder:validation:Optional
	LoadBalancerByolAllocationIDSelector *v1.Selector `json:"loadBalancerByolAllocationIdSelector,omitempty" tf:"-"`
...
type SddcInitParameters struct {
	...
	SddcByolAllocationDetails []SddcByolAllocationDetailsInitParameters `json:"sddcByolAllocationDetails,omitempty" tf:"sddc_byol_allocation_details,omitempty"`
...
type SddcObservation struct {
	...
	// (Updatable) The BYOL allocations used for VMware SDDC provisioning.
	SddcByolAllocationDetails []SddcByolAllocationDetailsObservation `json:"sddcByolAllocationDetails,omitempty" tf:"sddc_byol_allocation_details,omitempty"`
...
type SddcParameters struct {
	...
	// (Updatable) The BYOL allocations used for VMware SDDC provisioning.
	// +kubebuilder:validation:Optional
	SddcByolAllocationDetails []SddcByolAllocationDetailsParameters `json:"sddcByolAllocationDetails,omitempty" tf:"sddc_byol_allocation_details,omitempty"`
