...
type GuardDataSourceInitParameters struct {
...
type GuardDataSourceObservation struct {
...
type GuardDataSourceParameters struct {
...
// GuardDataSourceSpec defines the desired state of GuardDataSource
type GuardDataSourceSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     GuardDataSourceParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider GuardDataSourceInitParameters `json:"initProvider,omitempty"`
}

// GuardDataSourceStatus defines the observed state of GuardDataSource.
type GuardDataSourceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        GuardDataSourceObservation `json:"atProvider,omitempty"`
}
...
// GuardDataSource is the Schema for the GuardDataSources API. Provides the Data Source resource in Oracle Cloud Infrastructure Cloud Guard service
...
type GuardDataSource struct {
	...
	Spec   GuardDataSourceSpec   `json:"spec"`
	Status GuardDataSourceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// GuardDataSourceList contains a list of GuardDataSources
type GuardDataSourceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []GuardDataSource `json:"items"`
}

// Repository type metadata.
var (
	GuardDataSource_Kind             = "GuardDataSource"
	GuardDataSource_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GuardDataSource_Kind}.String()
	GuardDataSource_KindAPIVersion   = GuardDataSource_Kind + "." + CRDGroupVersion.String()
	GuardDataSource_GroupVersionKind = CRDGroupVersion.WithKind(GuardDataSource_Kind)
)

func init() {
	SchemeBuilder.Register(&GuardDataSource{}, &GuardDataSourceList{})
}
